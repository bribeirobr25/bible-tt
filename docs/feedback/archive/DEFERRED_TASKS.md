...
> **CLOSED AUDIT RECORD (historical, archived 2026-06-04).** Not an active task list — for currently-open items see `docs/audit/PENDING.md`. A redirect stub remains at `docs/feedback/DEFERRED_TASKS.md`.
