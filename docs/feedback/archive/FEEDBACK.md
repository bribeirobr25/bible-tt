...
> **CLOSED AUDIT RECORD (historical, archived 2026-06-04).** This is the provenance trail cited by rule proposals, CHANGELOGs, and editorial logs (by "FEEDBACK item N"). It is **not** an active task list — for currently-open items see `docs/audit/PENDING.md`. A redirect stub remains at `docs/feedback/FEEDBACK.md`.
