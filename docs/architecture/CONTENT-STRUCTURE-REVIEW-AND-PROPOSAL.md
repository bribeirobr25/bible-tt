...
- **Q5 = Yes — de-duplicate** continuous-reading vs. verse text (single source, derive the other).
- **Q6 = Yes — lazy/stream** the "Deeper" enrichment payload instead of hydrating it on the Reading default (with the Item-1 3-door build).
