...
**Luke 1–3 — EN authored, propagation pending (2026-06-22)** (`PLAN_LUKE_EXPANSION.md`, audited APPROVE; branch `luke-expansion`): book #5 activated + full EN Luke from NA28 (12 files), provisional. **Next:** (a) **PT-BR/DE/ES propagation** (Mark-style mirror, ~12 files/locale); (b) **Hellenist Rule-28 review** of the EN translation (cruxes flagged in-text: 1:28 κεχαριτωμένη, 1:35, 1:78, 2:14, 2:49, 3:22 + Ps 2:7 variant, the genealogy divergence from Matthew). Psalms/Proverbs/Ecclesiastes remain deferred (Hebrew-poetry genre + wisdom-file-set question).
