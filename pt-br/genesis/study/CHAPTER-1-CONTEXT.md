# Genesis 1 — Estudo Contextual Complementar
...
```
            Águas acima (contidas pelo céu)
     ──────────── RAQIA (céu/domo) ────────────
        Sol, lua, estrelas colocados NO raqia
     ──────────── Superfície da terra ────────────
        Mares reunidos, terra visível
     ──────────── Águas abaixo ────────────
        Águas subterrâneas, fontes, "o abismo"
```
...
| Fonte | Tipo | Seções |
|--------|------|----------|
| Pritchard, J.B. (ed.), *ANET*, 3rd ed., 1969 | Textos primários (antigo Oriente Próximo) | B1, B2 |
| Heidel, A., *The Babylonian Genesis*, 2nd ed., 1951 | Secundário (antigo Oriente Próximo) | B1 |
| Lambert, W.G. and Millard, A.R., *Atra-ḫasīs*, 1969 | Texto primário (acádico) | B2 |
| Allen, J.P., *Genesis in Egypt*, 1988 | Secundário (egípcio) | B3 |
| Horowitz, W., *Mesopotamian Cosmic Geography*, 1998 | Secundário (cosmologia do antigo Oriente Próximo) | C1 |
| Walton, J.H., *Ancient Near Eastern Thought and the OT*, 2006 | Secundário (contexto do antigo Oriente Próximo) | C1, E1 |
| Walton, J.H., *The Lost World of Genesis One*, 2009 | Secundário (interpretação) | C2, E1 |
| Levenson, J.D., *Creation and the Persistence of Evil*, 1988 | Secundário (teologia) | C2 |
...
- Conformidade com Regra 29: revisão pendente
