# Genesis 2 — Estudo Contextual Complementar
...
| Fonte | Tipo | Seções |
|--------|------|----------|
| Clifford, R.J., *Creation Accounts in the ANE and Bible*, 1994 | Secundário (antigo Oriente Próximo) | B1 |
| Stordalen, T., *Echoes of Eden*, 2000 | Secundário (motivos de jardim) | B2 |
| Walton, J.H., *Ancient Near Eastern Thought and the OT*, 2006 | Secundário (contexto do antigo Oriente Próximo) | B3, D |
| Speiser, E.A., *Genesis* (Anchor Bible), 1964 | Comentário | C1 |
| Hallo, W.W., "New Moons and Sabbaths," *HUCA* 48, 1977 | Artigo | C2 |
| Wheeler, B.M., *Prophets in the Quran*, 2002 | Secundário (islâmico) | F3 |
