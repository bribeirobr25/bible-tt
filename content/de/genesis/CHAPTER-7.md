...
- [Glossar — Genesis 7](#glossar---genesis-7)
- [Kapitelübergreifende Verfolgung (Gn 6 → Gn 7)](#kapitelübergreifende-verfolgung-gn-6--gn-7)
...
## GLOSSAR — GENESIS 7 (Ergänzungen zum Gn 1–6-Glossar)

| Hebräisch | Deutsch | Anmerkungen |
|-----------|---------|-------------|
| שִׁבְעָה שִׁבְעָה | sieben sieben | Distributive Wiederholung. NICHT „sieben Paare." Mehrdeutigkeit bewahrt. |
| טְהוֹרָה | rein | Rein/unrein-Unterscheidung erscheint vor der Sinai-Gesetzgebung. |
| יְקוּם | Stehendes | Alles, was steht/existiert. Nur hier + Dtn 11:6. |
| מַעְיָן | Quelle | Unterirdische Wasserquellen. Plural: *ma'yenot*. |
| אֲרֻבָּה | Fenster/Schleuse | Gitteröffnung. „Fenster des Himmels." |
| חָרָבָה | Trockenes | Unterschieden von *eretz* (Land) und *adamah* (Boden). |
