# Genesis 1 — Kontextuelle Studienbegleitung
...
**Kapitel:** Genesis 1
**Sprache:** Deutsch
**Begleitdatei zu:** `de/genesis/CHAPTER-1.md` (Transparente Ausgabe)
...
Diese Datei enthält Hintergrundmaterial, organisiert nach Themen. Jeder Eintrag trägt **zwei Kennzeichnungen:**

**Welche Art von Behauptung?** (gibt die Quelle der Information an)
- **TEXTUELL** — direkt aus dem hebräischen Text abgeleitet
- **STARKE SCHLUSSFOLGERUNG** — logisch vom Text impliziert, nicht explizit gesagt
...
- **HISTORISCH / ARCHÄOLOGISCH** — auf materiellem oder historischem Befund basierend
- **WISSENSCHAFTLICHER VERGLEICH** — moderner empirischer Befund im Vergleich zum Text
- **SPEKULATION** — keine starke textliche oder evidenzbasierte Grundlage

**Wie sicher?** (gibt das Gewissheitsniveau an)
...
**Leseprinzip:** Beginnen Sie mit den TEXTUELL-Einträgen — diese stammen aus dem Hebräischen selbst. Erkunden Sie dann nach aussen zu Parallelen, Rezeption und Vergleich. Der Companion präsentiert; Sie beurteilen.
...
**[TEXTUELL — VERIFIZIERT (Bogen) / MÖGLICHE SCHLUSSFOLGERUNG — MÖGLICH (was „Chaos" impliziert)]**
...
**[TEXTUELL / MÖGLICHE SCHLUSSFOLGERUNG — WAHRSCHEINLICH]**
...
**[WISSENSCHAFTLICHER VERGLEICH — WAHRSCHEINLICH]**
...
**[TEXTUELL / HISTORISCH — VERIFIZIERT]**
...
**[HISTORISCH / ARCHÄOLOGISCH — DOKUMENTIERT]** *(Traditionelle Zuschreibung; in jüdischer und christlicher Tradition weit verbreitet)*
...
**[HISTORISCH / ARCHÄOLOGISCH — MÖGLICH]** *(Verbunden mit der abschließenden Pentateuchgestaltung; Schmid, Römer)*
...
|--------|-----|------------|
| Pritchard, J.B. (Hrsg.), *ANET*, 3. Aufl., 1969 | Primärtexte (AO) | B1, B2 |
| Heidel, A., *The Babylonian Genesis*, 2. Aufl., 1951 | Sekundär (AO) | B1 |
| Lambert, W.G. und Millard, A.R., *Atra-ḫasīs*, 1969 | Primärtext (Akkadisch) | B2 |
| Allen, J.P., *Genesis in Egypt*, 1988 | Sekundär (Ägyptisch) | B3 |
| Horowitz, W., *Mesopotamian Cosmic Geography*, 1998 | Sekundär (AO Kosmologie) | C1 |
| Walton, J.H., *Ancient Near Eastern Thought and the OT*, 2006 | Sekundär (AO Kontext) | C1, E1 |
| Walton, J.H., *The Lost World of Genesis One*, 2009 | Sekundär (Interpretation) | C2, E1 |
| Levenson, J.D., *Creation and the Persistence of Evil*, 1988 | Sekundär (Theologie) | C2 |
| Tottoli, R., *Biblical Prophets in the Qur'an*, 2002 | Sekundär (Islamisch) | F3 |
| *Bereshit Rabba* (5. Jh. n. Chr.) | Primär (Rabbinisch) | F1 |
| Rashi, Kommentar zu Genesis (11. Jh.) | Primär (Mittelalterlich-Jüdisch) | F1 |
| Maimonides, *Führer der Unschlüssigen* (12. Jh.) | Primär (Mittelalterlich-Jüdisch) | F1 |
| Augustinus, *De Genesi ad Litteram* (4.-5. Jh.) | Primär (Patristisch) | F2 |
| Basilius von Cäsarea, *Hexaemeron* (4. Jh.) | Primär (Patristisch) | F2 |
...
- Regel-29-Konformität: ausstehende Überprüfung
