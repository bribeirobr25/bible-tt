# Matthäus 3 — Kontextuelle Studienbegleitung
...
**Kapitel:** Matthäus 3
**Sprache:** Deutsch
**Begleitung zu:** `de/matthew/CHAPTER-3.md` (Transparente Ausgabe)
**Regelwerk:** v3.3 (Regel 29 regelt diese Datei)
**Status:** provisorisch

---

## WIE DIESE BEGLEITUNG ZU VERWENDEN IST
...
**Leseprinzip:** Beginnen Sie mit TEXTUELLEN Einträgen — diese stammen aus dem Griechischen selbst. Dann erkunden Sie nach außen zu Parallelen, Rezeption und Vergleich. Die Begleitung präsentiert; Sie beurteilen.

---

## A. Vom TT freigelegte Quelltextmerkmale
...
## B. Parallelen aus der Zeit des Zweiten Tempels
...
## D. Sprachliche und philologische Vertiefungen
...
| Quelle | Typ | Verwendet in Abschnitten |
|--------|-----|--------------------------|
| Davies, W.D. und Allison, D.C., *ICC Matthew*, Bd. 1, 1988 | PEER-REVIEWED (commentary) | A, D, G |
...
| Lieberman, S., *Hellenism in Jewish Palestine*, 2. Aufl., 1962 | PEER-REVIEWED (monograph) | F |
| Murphy-O'Connor, J., *The Holy Land*, 5. Aufl., 2008 | ACADEMIC POPULAR | C |
| Nestle-Aland, *Novum Testamentum Graece*, 28. Aufl. | PRIMARY | A |
...
| VanderKam, J., *The Dead Sea Scrolls Today*, 2. Aufl., 2010 | PEER-REVIEWED (monograph) | B |
