...
**Buch:** Matthäus (Μαθθαῖος, *Maththaios*)
**Sprache:** Deutsch
**Einführung zu:** `de/matthew/` (Transparente Ausgabe)
...
**Welche Art von Behauptung?** (zeigt die Quelle der Information an)
- **TEXTUELL** -- direkt aus dem griechischen Text abgeleitet
- **STARKE SCHLUSSFOLGERUNG** -- logisch vom Text impliziert, nicht ausdrücklich angegeben
- **MÖGLICHE SCHLUSSFOLGERUNG** -- eine berechtigte Lesart unter anderen
- **VERGLEICHENDE PARALLELE** -- in einer anderen antiken Quelle belegt
- **SPÄTERE REZEPTION** -- nachbiblische Lesart
- **HISTORISCH / ARCHÄOLOGISCH** -- auf materiellem oder historischem Beweismaterial basierend
- **WISSENSCHAFTLICHER VERGLEICH** -- moderne empirische Beobachtung verglichen mit dem Text
- **SPEKULATION** -- keine starke textliche oder belegmäßige Grundlage

**Wie sicher?** (zeigt das Vertrauensniveau an)
- **VERIFIZIERT** -- starkes Beweismaterial, breite Übereinstimmung
- **WAHRSCHEINLICH** -- gut gestützt, aber umstritten
- **MÖGLICH** -- eine vertretbare Lesart unter anderen
- **UNSICHER** -- tatsächlich unklar
- **SPEKULATIV** -- muss selten sein und klar gekennzeichnet
- **DOKUMENTIERT** -- historisch bezeugte Rezeption (für Einträge SPÄTERER REZEPTION)

**Leseprinzip:** Beginnen Sie mit TEXTUELLEN Einträgen -- diese stammen aus dem Griechischen selbst. Dann erkunden Sie nach außen zu Parallelen, Rezeption und Vergleich. Die Einführung präsentiert; Sie beurteilen.
...
Matthäus ist um fünf große Redeblöcke organisiert, von denen jeder mit der Formel „und es geschah, als Yeshua diese Worte/Reden beendet hatte" (καὶ ἐγένετο ὅτε ἐτέλεσεν ὁ Ἰησοῦς τοὺς λόγους τούτους, oder Variante) abgeschlossen wird. Diese fünfgliedrige Struktur ist seit B. W. Bacon (1918) weithin bemerkt worden:
...
**Rede 3 -- Gleichnisrede (Kapitel 13):** Sieben Gleichnisse vom Königreich der Himmel -- Sämann, Weizen und Unkraut, Senfkorn, Sauerteig, verborgener Schatz, Perle, Schleppnetz. Lehre darüber, warum Yeshua in Gleichnissen spricht (13,10-17).
...
**Ursprünge und Vorbereitung (1,1-4,16):** Genealogie (1,1-17), Geburtserzählung (1,18-2,23), Dienst Yochanans des Eintauchers (3,1-12), Yeshuas Eintauchung und Versuchung (3,13-4,11), Rückzug nach Galiläa (4,12-16).

**Galiläischer Dienst (4,17-16,20):** Öffentliche Lehre und Heilung, beginnend mit „Von da an begann Yeshua zu verkündigen" (4,17). Die fünf Reden fallen hauptsächlich in diesen Abschnitt. Das Bekenntnis des Kefa bei Cäsarea Philippi (16,13-20) markiert einen Wendepunkt.

**Weg nach Yerushalayim und Passion (16,21-27,66):** Leidensankündigungen, Einzug in Yerushalayim, Tempelstreitigkeiten, die eschatologische Rede, das letzte Mahl, Verhaftung, Prozess, Kreuzigung, Begräbnis.
...
## B. Verfasserschaft und Abfassung
...
Der Verfasser war wahrscheinlich ein griechisch sprechender jüdischer Christ mit starker schriftgelehrter Ausbildung, tiefer Kenntnis der Hebräischen Schriften (sowohl in hebräischer als auch in LXX-Form) und Zugang zum Markusevangelium und zusätzlicher Überlieferung (Q oder Entsprechendes).
...
**[VERGLEICHENDE PARALLELE -- MÖGLICH]**
...
- Die Genealogie (1,1-17) strukturiert Yeshuas Abstammung über Avraham und David -- Gestalten, deren Bedeutung keiner Erklärung bedarf.
...
## E. Handschriftliche Überlieferung
...
Abfassung (ca. 80-90 u.Z.)
     ↓
Frühe Abschriften (2.-3. Jahrhundert u.Z.)
  ├── P1 (3. Jh.) -- Mt 1,1-9, 12, 14-20
  ├── P45 (3. Jh.) -- Teile aller vier Evangelien + Apostelgeschichte
  ├── P64+67 (spätes 2. Jh.) -- Mt 3, 5, 26
  └── P104 (2. Jh.) -- Mt 21,34-37, 43, 45
     ↓
Große Kodizes (4.-5. Jahrhundert u.Z.)
...
Das Matthäusevangelium hat keine textliche Störung vergleichbar mit der Perikope von der Ehebrecherin (Joh 7,53-8,11) oder dem längeren Markusschluss (Mk 16,9-20). Der Text ist über die Handschriftentradition hinweg relativ stabil. Bemerkenswerte Varianten umfassen:
...
|-----------------|---------------|----------|
| Jesus | Yeshua | Ἰησοῦς (*Iēsous*) ← Hebräisch/Aramäisch יֵשׁוּעַ (*Yeshua*) |
| Maria (Mutter) | Miryam | Μαρία/Μαριάμ (*Maria/Mariam*) ← Hebräisch מִרְיָם (*Miryam*) |
| Josef | Yosef | Ἰωσήφ (*Iōsēph*) ← Hebräisch יוֹסֵף (*Yosef*) |
| Johannes der Täufer | Yochanan der Eintaucher | Ἰωάννης (*Iōannēs*) ← Hebräisch יוֹחָנָן (*Yochanan*); βαπτιστής als „Eintaucher" gemäß gesperrtem Glossar |
| Abraham | Avraham | Ἀβραάμ (*Abraam*) ← Hebräisch אַבְרָהָם (*Avraham*) |
| Isaak | Yitschaq | Ἰσαάκ (*Isaak*) ← Hebräisch יִצְחָק (*Yitschaq*) |
| Jakob | Ya'aqov | Ἰακώβ (*Iakōb*) ← Hebräisch יַעֲקֹב (*Ya'aqov*) |
| Juda | Yehudah | Ἰούδας (*Ioudas*) ← Hebräisch יְהוּדָה (*Yehudah*) |
| David | David | Δαυίδ (*Dauid*) ← Hebräisch דָּוִד (*David*) |
| Salomo | Shelomoh | Σολομών (*Solomōn*) ← Hebräisch שְׁלֹמֹה (*Shelomoh*) |
| Herodes | Herodes | Ἡρῴδης (*Hērōdēs*) -- griechisch/lateinischer Name, in Transliteration beibehalten |
...
| Stelle | AT-Quelle | Inhalt |
|--------|-----------|--------|
| 1,22-23 | Jes 7,14 | „Die *parthenos* wird empfangen" -- siehe F4 unten |
| 2,5-6 | Mi 5,2 (+ 2 Sam 5,2) | Bethlehem als Geburtsort |
| 2,15 | Hos 11,1 | „Aus Mitsrayim rief ich meinen Sohn" |
| 2,17-18 | Jer 31,15 | Rachel weint über ihre Kinder |
| 2,23 | Unbekannt / Kompositum | „Er wird ein Natsri genannt werden" |
| 3,3 | Jes 40,3 | Stimme eines Rufenden in der Wüste |
...
- Wenn sich *kyrios* auf Yeshua oder einen menschlichen Herrn bezieht (kein AT-JHWH-Zitat), ist keine JHWH-Anmerkung nötig.
...
| Regel | Name | Matthäusspezifische Anwendung |
|-------|------|-------------------------------|
| 1 | Erste Direktive | Nicht die Struktur der Genealogie (drei Sätze von vierzehn) vereinfachen oder ihre historischen Spannungen auflösen. |
| 3 | Keine importierte Theologie | Die Geburtserzählung wird übersetzt, wie der Text sie präsentiert -- ohne spätere marianische Theologie zu importieren oder die Erzählung als Mythos abzutun. Zurückhaltung in beide Richtungen. |
| 4 | Keine interpretive Paraphrase | „Königreich der Himmel" wörtlich wiedergegeben, nicht als „Himmelreich" oder „Gottes Reich" paraphrasiert. |
| 7 | Semantische Bandbreite bewahren | *Parthenos* in 1,23 trägt seine volle griechische semantische Bandbreite (junge Frau/Jungfrau); vermerkt statt kollabiert. |
| 11 | Grammatische Zusätze kennzeichnen | Für deutsche Grammatik hinzugefügte Wörter erscheinen kursiv. |
| 13 | Unsicherheitsstufen | Umstrittene Begriffe und genealogische Fragen tragen Vertrauenskennzeichnungen. |
| 14 | Quelltextnotizen | Wesentliche griechische Begriffe in Transliteration bewahrt, wo semantisch bedeutsam. |
| 22 | Keine interpretativen Abschnittsüberschriften | Abschnittsunterteilungen legen dem Text keine Lesart auf. |
| 25 | JHWH konsonantisch wiedergegeben | Angewandt in AT-Zitatskontexten gemäß der Gottesname-Politik (F5). |

---

## G. Konsultierte Quellen

| Quelle | Typ | Abschnitte |
|--------|-----|------------|
| Davies, W. D. und Allison, D. C. *A Critical and Exegetical Commentary on the Gospel According to Saint Matthew* (ICC, 1988-1997) | Kommentar | A, B, C, D |
| Luz, U. *Das Evangelium nach Matthäus* (EKK, 1985-2002) | Kommentar | A, B, C |
| Hagner, D. A. *Matthew* (WBC, 1993-1995) | Kommentar | B |
| Kingsbury, J. D. *Matthew: Structure, Christology, Kingdom* (1975) | Struktur/Theologie | A |
| Bacon, B. W. „The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918) | Struktur | A |
| Stendahl, K. *The School of St. Matthew* (1954) | Abfassung | B |
...
> **Redaktionelle Herkunft:** Entworfen von Claude Opus 4.6 (1M Kontext) am 2026-04-27. Noch nicht begutachtet. Diese Einführung ist eine provisorische wissenschaftliche Ressource, geregelt durch TT-Regel 29. Alle Behauptungen tragen doppelte Kennzeichnungen; keine Behauptung sollte als die theologische oder kompositorische Position der TT gelesen werden. Die TT übersetzt den griechischen Text (NA28) und übernimmt keine bestimmte Theorie der Verfasserschaft oder Abfassung.
