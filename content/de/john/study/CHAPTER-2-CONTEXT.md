# Johannes 2 — Kontextuelle Studienbegleitung
...
**Kapitel:** Johannes 2
**Sprache:** Deutsch
**Begleitung zu:** `de/john/CHAPTER-2.md` (Transparente Ausgabe)
...
Joh 2,11: ταύτην ἐποίησεν ἀρχὴν τῶν σημείων ὁ Ἰησοῦς — „diesen Anfang der Zeichen tat Jesus." Das Substantiv σημεῖον (*sēmeion*) = „Zeichen" — etwas, das über sich selbst hinaus auf eine bezeichnete Wirklichkeit weist. Die synoptischen Evangelien verwenden δύναμις (*dynamis*, „Kraft/mächtiges Wirken") als ihren Hauptbegriff für Jesuss außergewöhnliche Taten (Mt 11,20; Mk 6,2; Lk 10,13). Johannes verwendet *dynamis* nie für Jesuss Taten. Die terminologische Wahl ist durchgängig und bewusst: Die johanneischen *sēmeia* (Zeichen) sind keine Zurschaustellungen roher Kraft, sondern offenbarende Hinweise — sie „offenbaren seine Herrlichkeit" (2,11), enthüllen, wer Jesus ist, und laden zum Vertrauen ein. Die traditionelle deutsche Wiedergabe „Wunder" verwischt die Unterscheidung zwischen dem johanneischen *sēmeion* (offenbarender Hinweis) und dem synoptischen *dynamis* (mächtige Tat). Die TT bewahrt den johanneischen Begriff.
...
|--------|-----|------------|
| Nestle-Aland, *Novum Testamentum Graece*, 28. rev. Aufl. (Deutsche Bibelgesellschaft, 2012) | PRIMARY | Alle |
| LXX (Rahlfs-Hanhart, *Septuaginta*, rev. Aufl., Deutsche Bibelgesellschaft, 2006) | PRIMARY | A2, D1 |
| BHS, 5. rev. Aufl. (Deutsche Bibelgesellschaft, 1997) | PRIMARY | D1 |
| Dodd, C.H., *The Interpretation of the Fourth Gospel*, Cambridge University Press, 1953 | PEER-REVIEWED (monograph) | B1 |
| Bultmann, R., *Das Evangelium des Johannes*, Vandenhoeck & Ruprecht, 1941 | PEER-REVIEWED (commentary) | B1 |
| Barrett, C.K., *The Gospel According to St John*, 2nd ed., SPCK, 1978 | PEER-REVIEWED (commentary) | B1 |
| Edwards, D.R., „Khirbet Qana," in *The Roman and Byzantine Near East*, Bd. 3, JRA Supplement 49, 2002 | PEER-REVIEWED (article) | C1 |
| Richardson, P., *Building Jewish in the Roman East*, Baylor University Press, 2004 | PEER-REVIEWED (monograph) | C1 |
| Safrai, S. und Stern, M., Hrsg., *The Jewish People in the First Century*, Bd. 2, Van Gorcum, 1976 | PEER-REVIEWED (edited volume) | C2 |
| Reed, J.L., *Archaeology and the Galiläaean Jesus*, Trinity Press International, 2000 | PEER-REVIEWED (monograph) | C2 |
...
| Bauckham, R., „Jesus' Demonstration in the Temple," in *Law and Religion*, Hrsg. B. Lindars, James Clarke, 1988 | PEER-REVIEWED (essay) | C3 |
| Jeremias, J., *Jerusalem zur Zeit Jesu*, Vandenhoeck & Ruprecht, 1962 | PEER-REVIEWED (monograph) | C4 |
...
| Cullmann, O., *Urchristentum und Gottesdienst*, Zwingli-Verlag, 1950 | PEER-REVIEWED (monograph) | F2 |
...
| Deines, R., *Jüdische Steingefäße und pharisäische Frömmigkeit*, WUNT 2/52, Mohr Siebeck, 1993 | PEER-REVIEWED (monograph) | G2 |
