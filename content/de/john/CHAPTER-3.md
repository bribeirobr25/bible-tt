...
**Worauf achten:** Die *anōthen*-Doppelbedeutung (V.3) — räumlich „von oben" oder zeitlich „von neuem"; das Wind/Geist-Wortspiel (V.8) — Wind und Geist sind dasselbe griechische Wort; wo Jesu Rede endet und die Stimme des Erzählers beginnt (nach V.12? V.15? V.21?); der Ausdruck „einziggeborener Sohn" in VV.16 und 18 — „einziggeboren," nicht „einziggezeugt"; „Leben des Zeitalters" — nicht „ewiges Leben"; „Gericht" in V.19 — nicht „Verdammnis"; die Aussage, dass Jesus selbst untertauchte (V.22, korrigiert in 4,2); die *ouk ... alla*-Konstruktion („nicht X, sondern Y"), die Johannes' Selbstverkleinerung strukturiert.
