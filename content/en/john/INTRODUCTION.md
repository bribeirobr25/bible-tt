...
**Source:** Dodd, *The Interpretation of the Fourth Gospel* (1953), 289–443; Brown, *John* (AB), I.cxxxviii–cxliv.

### A3. Distinctive features
**[TEXTUAL — VERIFIED]**
...
The attribution of the Fourth Gospel to Yochanan (John) son of Zebedee became standard from the late second century onward:

- **Irenaeus** (*Adversus Haereses* 3.1.1, c. 180 CE) states: "John, the disciple of the Lord, who also leaned on his breast, himself published the Gospel, while living at Ephesus in Asia." Irenaeus claims to have received this tradition through Polycarp, who knew John.
- **The Muratorian Fragment** (late 2nd century) attributes the Gospel to John and adds a narrative about its composition.
- **Clement of Alexandria** (quoted by Eusebius, *HE* 6.14.7) describes John's Gospel as a "spiritual gospel," composed last, after the other evangelists had recorded "the bodily facts."
- **Eusebius** (*HE* 3.24.5–13) transmits the tradition while noting complications, including the existence of a second "John the Elder" mentioned by Papias.

This attribution was essentially unquestioned in Christian tradition until the modern period.

**Source:** Hengel, *The Johannine Question* (1989); Hill, *The Johannine Corpus in the Early Church* (2004), 172–205.

### B3. Modern scholarship
...
**Source:** Brown, *The Community of the Beloved Disciple* (1979); Martyn, *History and Theology in the Fourth Gospel* (3rd ed., 2003); Bauckham, *The Testimony of the Beloved Disciple* (2007).
...
A minority of scholars argue for an earlier date (60s–70s CE), noting that the Gospel does not mention the destruction of the Temple (70 CE) as a past event and that some historical details suggest familiarity with pre-70 Jerusalem.

**Source:** Brown, *John* (AB), I.lxxx–lxxxvi; Schnackenburg, *The Gospel According to St John* (1968–82), I.101–104; Anderson, *The Riddles of the Fourth Gospel* (2011), 125–140.

### C2. P52 — the oldest surviving NT manuscript fragment
**[HISTORICAL / ARCHAEOLOGICAL — VERIFIED]**

P52 (Rylands Library Papyrus 457, also called the Rylands Fragment) is a small papyrus fragment containing portions of John 18:31–33 (recto) and 18:37–38 (verso). It is housed in the John Rylands Library, Manchester. Paleographic dating places it at approximately 125 CE (with a range of c. 100–150 CE), making it the oldest known manuscript fragment of any New Testament text.

P52 demonstrates that the Gospel of John was circulating in Egypt by the early-to-mid second century, consistent with a composition date no later than c. 100 CE and likely earlier (allowing time for copying and distribution from the place of composition to Egypt).

**Source:** Roberts, *An Unpublished Fragment of the Fourth Gospel in the John Rylands Library* (1935); Nongbri, "The Use and Abuse of P52," *HTR* 98 (2005): 23–48.

---

## D. Historical Setting

### D1. Post-Temple Judaism
**[HISTORICAL / ARCHAEOLOGICAL — PROBABLE]**
...
### D3. Greco-Roman intellectual context
**[COMPARATIVE PARALLEL — PROBABLE]**

The Gospel's prologue (1:1–18) opens with the concept of λόγος (*logos*), a term with deep roots in Greek philosophical tradition:
...
**Source:** Dodd, *The Interpretation of the Fourth Gospel*, 263–285; Boyarin, *The Jewish Gospels* (2012), 89–101.

### D4. Possible Ephesus setting
**[LATER RECEPTION — DOCUMENTED]**
...
| Witness | Date | Contents relevant to John | Significance |
|---------|------|---------------------------|-------------|
| P52 (Rylands Papyrus) | c. 125 CE | John 18:31–33, 37–38 | Oldest surviving NT manuscript fragment |
| P66 (Bodmer II) | c. 200 CE | Nearly complete Gospel of John (1:1–6:11, 6:35–14:26, fragments of 14–21) | Earliest extensive witness to John; mixed text-type |
| P75 (Bodmer XIV–XV) | c. 200–225 CE | John 1–15 (bound with Luke) | Close to Codex Vaticanus text; key witness for the Alexandrian text-type |
| Codex Sinaiticus (א) | 4th c. CE | Complete NT including John | One of the two most important majuscule witnesses |
| Codex Vaticanus (B) | 4th c. CE | Complete John (within complete NT) | Generally regarded as the most reliable single manuscript |
| Codex Bezae (D) | 5th c. CE | John (bilingual Greek-Latin) | Important witness to the "Western" text-type; significant variants |
| Codex Alexandrinus (A) | 5th c. CE | Complete John | Mixed text-type; important for Byzantine readings |

### E3. Major textual variants
**[HISTORICAL / ARCHAEOLOGICAL — VERIFIED]**
...
The following locked glossary entries from RULES-GS.md apply throughout the Gospel of John:

| Greek | TT rendering (EN) | Notes |
|-------|-------------------|-------|
| λόγος (*logos*) | word | Lowercase in main text. John 1:1 receives a critical note on semantic range (word/reason/account). |
| χριστός (*christos*) | anointed one | Lowercase when functioning as descriptor; capitalized only when clearly functioning as proper name. Maps to HB מָשִׁיחַ (*mashiach*). |
| ἐκκλησία (*ekklesia*) | assembly | Not "church" (anachronistic institutional meaning). The Greek means "called-out gathering." Not frequent in John but active in the TT system. |
| βάπτισμα (*baptisma*) | immersion | Not transliterated. The Greek has clear semantic content: "dipping/immersion." |
| παράκλητος (*paraklētos*) | advocate | Translate the meaning. Note semantic range (comforter/helper/advocate/called-alongside) in Tier 2 notes. Unique to John among the Gospels (14:16, 26; 15:26; 16:7). |
| κύριος (*kyrios*) | Context-dependent | When quoting OT YHWH passages: "the Lord" + note identifying YHWH. Otherwise: "lord/master." See Divine Name Policy. |
...
Greek verb aspect is semantically significant in John. The TT notes aspect at key points:

- **Aorist:** Typically used for punctiliar or summary action. Rendered in English past tense with aspect note where the choice affects interpretation.
- **Present:** Typically used for ongoing, repeated, or internally viewed action. Rendered with progressive or habitual nuance as context requires.
- **Perfect:** Denotes a state resulting from a completed action. Semantically distinct from both aorist and present. Key examples in John: "it is written" (γέγραπται, *gegraptai*), "I have come" (ἐλήλυθα, *elēlytha*).
- **Middle voice:** Distinguished from active where the distinction is semantically significant.

### F5. Transliterated proper names
**[TEXTUAL — VERIFIED]**

Per the TT's transliteration policy, key proper names in John are rendered from their original forms rather than from anglicized tradition:
...
### F6. Translation challenges specific to John
**[TEXTUAL — PROBABLE]**
...
|--------|------|----------|
| Brown, R. E. *The Gospel According to John* (AB, 1966–1970) | Commentary | A, B, C, F |
| Barrett, C. K. *The Gospel According to St John* (2nd ed., 1978) | Commentary | A, B, F |
| Schnackenburg, R. *The Gospel According to St John* (1968–1982) | Commentary | A, C |
| Dodd, C. H. *The Interpretation of the Fourth Gospel* (1953) | Theology/Structure | A, D |
| Brown, R. E. *The Community of the Beloved Disciple* (1979) | Community history | B |
| Martyn, J. L. *History and Theology in the Fourth Gospel* (3rd ed., 2003) | Historical setting | B, D |
| Bauckham, R. *The Testimony of the Beloved Disciple* (2007) | Authorship | B |
| Hengel, M. *The Johannine Question* (1989) | Authorship | B, D |
| Hill, C. E. *The Johannine Corpus in the Early Church* (2004) | Reception | B |
| Smith, D. M. *John Among the Gospels* (2nd ed., 2001) | Gospel relationships | A |
| Kysar, R. *Voyages with John* (2005) | Introduction | A |
| Anderson, P. N. *The Riddles of the Fourth Gospel* (2011) | Dating/Composition | C |
| Reinhartz, A. *Cast Out of the Covenant* (2018) | "The Yehudim" | D |
| Bieringer, R. et al., eds. *Anti-Judaism and the Fourth Gospel* (2001) | Historical setting | D |
| Boyarin, D. *The Jewish Gospels* (2012) | Intellectual context | D |
| Trebilco, P. *The Early Christians in Ephesus from Paul to Ignatius* (2004) | Setting | D |
