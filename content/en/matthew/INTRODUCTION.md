...
**Reading principle:** Start with TEXTUAL entries — those come from the Greek itself. Then explore outward to parallels, reception, and comparison. The introduction presents; you assess.
...
**Source:** Bacon, "The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918): 56–66; Kingsbury, *Matthew: Structure, Christology, Kingdom* (1975), 1–39.

### A3. Narrative framework
**[TEXTUAL — VERIFIED]**
...
**Source:** Kingsbury, *Matthew: Structure, Christology, Kingdom*, 7–25; Davies and Allison, *Matthew* (ICC), I.58–72.
...
The Gospel of Matthew does not name its author. The text is anonymous — no internal statement identifies who composed it. The title "According to Matthew" (ΚΑΤΑ ΜΑΘΘΑΙΟΝ) is a later addition found in manuscript headings but not part of the original composition. Unlike the Pauline epistles or the book of Revelation, the Gospel provides no first-person authorial identification.

The text does mention "Matthew" (Μαθθαῖος) at 9:9 (the call of a tax collector named Matthew) and 10:3 (listing "Matthew the tax collector" among the twelve). The parallel passage in Mark 2:14 names this tax collector "Levi son of Alphaeus." Whether "Matthew" and "Levi" are the same person, or whether the Gospel of Matthew has substituted one name for the other, is debated.
...
- Does *Hebraidi dialektō* mean "in the Hebrew language," "in Aramaic," or "in a Hebrew style"?
- If Papias describes an Aramaic/Hebrew original, the extant Greek Gospel shows no signs of being a translation from a Semitic source — it is composed in fluent Greek and depends on the Greek Gospel of Mark.

Later writers (Irenaeus, *Adv. Haer.* 3.1.1; Origen via Eusebius, *HE* 6.25.4) repeat and elaborate the tradition. By the late second century, apostolic authorship was standard.

**Source:** Luz, *Matthew* (Hermeneia), I.47–54; Davies and Allison, *Matthew* (ICC), I.7–17.

### B3. Modern assessment
**[COMPARATIVE PARALLEL — PROBABLE]**

Most contemporary scholars doubt that the apostle Matthew wrote the Gospel in its present form. The primary reasons:

- **Dependence on Mark:** The Gospel incorporates approximately 90% of Mark's content, often verbatim in Greek. A direct eyewitness and apostle would be unlikely to rely so heavily on a non-eyewitness source (Mark is traditionally associated with Peter's testimony, not with independent authority).
- **Greek composition:** The Gospel is written in competent Greek, not translated from Aramaic or Hebrew. Papias's testimony about a Hebrew/Aramaic composition does not match the extant text.
...
Most scholars date the Gospel of Matthew to approximately 80–90 CE, based on several converging considerations:

- **Dependence on Mark:** Mark is generally dated to c. 65–70 CE. Matthew's use of Mark as a source requires a later date.
- **Post-Temple indicators:** The parable of the wedding banquet (22:1–14) includes the detail that "the king... sent his armies and destroyed those murderers and burned their city" (22:7). This language closely mirrors the Roman destruction of Jerusalem in 70 CE and is widely read as a post-factum reference. The parallel in Luke 14:15–24 lacks this detail.
- **Developed ecclesiology:** The use of ἐκκλησία (*ekklesia*, "assembly," 16:18; 18:17) — unique among the Gospels — suggests a stage of community organization beyond the earliest period.
- **Tension with the synagogue:** The phrase "their synagogues" (4:23; 9:35; 10:17; 12:9; 13:54; 23:34) implies a perspective from outside the synagogue, consistent with a post-70 separation.

A minority of scholars argue for a pre-70 date, noting that 22:7 could be prophetic rather than retrospective and that some traditions in Matthew may reflect early Palestinian material.

**Source:** Davies and Allison, *Matthew* (ICC), I.127–138; Luz, *Matthew* (Hermeneia), I.55–60.

---

## D. Historical Setting

### D1. Post-70 Jewish-Christian community
**[HISTORICAL / ARCHAEOLOGICAL — PROBABLE]**
...
### D2. The Antioch hypothesis
**[COMPARATIVE PARALLEL — POSSIBLE]**

A significant scholarly tradition locates the composition of Matthew in Antioch (modern Antakya, Turkey). The arguments:

- Antioch had a large Jewish community and an early, significant Christian presence (Acts 11:19–26).
- Ignatius of Antioch (c. 110 CE) appears to know Matthew's Gospel, providing a terminus ante quem consistent with Antiochene composition.
- The Gospel's dual concern with Jewish identity and Gentile mission fits a mixed community in a major urban center.

This remains a hypothesis — the Gospel does not name its place of composition, and other locations (Galilee, Caesarea Maritima, Alexandria) have been proposed.

**Source:** Meier, "Antioch," in Brown and Meier, *Antioch and Rome* (1983), 12–86; Sim, *The Gospel of Matthew and Christian Judaism* (1998).

### D3. Audience — a heavily Jewish community
...
| Witness | Date | Contents relevant to Matthew | Significance |
|---------|------|------------------------------|-------------|
| P1 (Oxyrhynchus Papyrus 2) | 3rd c. CE | Matt 1:1–9, 12, 14–20 | Earliest substantial papyrus of Matthew |
| P64+67 (Magdalen Papyrus) | late 2nd c. CE | Matt 3:9, 15; 5:20–22, 25–28; 26:7–8, 10, 14–15, 22–23, 31–33 | Among the earliest witnesses; Carsten Thiede's controversial early dating (mid-1st c.) is not widely accepted |
| P104 | 2nd c. CE | Matt 21:34–37, 43, 45 | Very early fragment |
| P45 (Chester Beatty I) | 3rd c. CE | Portions of Matt, Mark, Luke, John, Acts | Earliest multi-Gospel codex |
| Codex Sinaiticus (א) | 4th c. CE | Complete Matthew | One of the two most important majuscule witnesses |
| Codex Vaticanus (B) | 4th c. CE | Complete Matthew | Generally regarded as the most reliable single manuscript |
| Codex Bezae (D) | 5th c. CE | Matthew (bilingual Greek-Latin) | Important witness to the "Western" text-type |

### E3. Textual stability
**[HISTORICAL / ARCHAEOLOGICAL — VERIFIED]**
...
## F. Reading Matthew in the TT

### F1. "Kingdom of the skies"
**[TEXTUAL — VERIFIED]**

Matthew's characteristic phrase βασιλεία τῶν οὐρανῶν (*basileia tōn ouranōn*, literally "kingdom of the heavens/skies") occurs approximately 32 times in the Gospel — a phrase unique to Matthew among the Gospels. The parallel passages in Mark and Luke consistently use βασιλεία τοῦ θεοῦ (*basileia tou theou*, "kingdom of God"), which Matthew also uses occasionally (12:28; 19:24; 21:31, 43).

The TT renders this phrase as "kingdom of the skies" — a literal translation of the Greek plural *ouranōn* that avoids the theological loading of the traditional "kingdom of heaven" (which in English connotes an afterlife destination rather than God's reign). The phrase likely reflects a Jewish circumlocution for the divine name — using "heavens" to avoid saying "God" directly — but this is inference, not something the text states. The TT translates what the text says; the circumlocution hypothesis belongs in a note.

### F2. TT transliterated names in Matthew
**[TEXTUAL — VERIFIED]**

Per the TT's transliteration policy, key proper names in Matthew are rendered from their original forms:
...
| 2:23 | Unknown / composite | "He will be called a Nazarene" |
| 3:3 | Isa 40:3 | Voice crying in the wilderness |

The TT translates each quotation from the Greek as it appears in Matthew (which sometimes differs from both the MT and the LXX) and notes the OT source, any divergence from the Hebrew, and the interpretive moves involved. The translation does not endorse or reject the fulfillment claim — it translates what the text says.

### F4. Parthenos/almah at 1:23
**[TEXTUAL — PROBABLE]**

Matthew 1:23 quotes Isaiah 7:14 using the Greek word παρθένος (*parthenos*, "virgin"). The Hebrew source text (Isa 7:14) uses עַלְמָה (*almah*), which means "young woman" (of marriageable age) — a term that does not in itself specify virginity. The LXX translated *almah* as *parthenos*, and Matthew follows the LXX reading.

The TT translates *parthenos* as it stands in the Greek text of Matthew (not substituting the Hebrew *almah*), but provides a note documenting:
- The Hebrew source uses *almah*, not *betulah* (the standard Hebrew term for "virgin").
- The LXX's choice of *parthenos* already represents an interpretive translation.
- Matthew follows the LXX reading, not the MT directly.

This is a translation decision, not a theological position. The TT documents the textual situation.
...
### F6. Active rules with Matthew-specific applications
**[TEXTUAL — VERIFIED]**
...
|--------|------|----------|
| Davies, W. D. and Allison, D. C. *A Critical and Exegetical Commentary on the Gospel According to Saint Matthew* (ICC, 1988–1997) | Commentary | A, B, C, D |
| Luz, U. *Matthew* (Hermeneia, 2001–2007) | Commentary | A, B, C |
| Hagner, D. A. *Matthew* (WBC, 1993–1995) | Commentary | B |
| Kingsbury, J. D. *Matthew: Structure, Christology, Kingdom* (1975) | Structure/Theology | A |
| Bacon, B. W. "The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918) | Structure | A |
| Stendahl, K. *The School of St. Matthew* (1954) | Composition | B |
...
> **Editorial provenance:** Drafted by Claude Opus 4.6 (1M context) on 2026-04-27. Not yet reviewed. This introduction is a provisional scholarly resource governed by TT Rule 29. All claims carry dual labels; no claim should be read as the TT's theological or compositional position. The TT translates the Greek text (NA28) and does not adopt any particular theory of authorship or composition.
