...
Genesis 2:1–3: God rests on the seventh day and sanctifies it. The first thing called holy in the Bible is a *time*, not a place or object. This connects to the Sabbath institution, which is attested archaeologically in Israelite practice from at least the 8th century BCE (ostraca, inscriptions).
...
- **Lilith tradition** (Alphabet of Ben Sira, medieval): some rabbinic texts posit a "first woman" before Eve, based on tensions between Gen 1:27 ("male and female he created them") and Gen 2:22 (woman built from side/rib). This is **LATER RECEPTION**, not in the Hebrew text.
...
- The *ish/ishah* pair is widely cited in Christian theology as the basis for complementarian or egalitarian views — both citing the same text. The Hebrew does not resolve this debate.

### F3. Islamic reception
**[LATER RECEPTION — DOCUMENTED]**

The Quran describes Adam's creation from clay (*tin*, Surah 15:26) and the teaching of names to Adam (Surah 2:31) — paralleling Gen 2:7 and 2:19–20. The Quranic account does not include the *ish/ishah* wordplay or the specific *tsela* (side/rib) narrative.
