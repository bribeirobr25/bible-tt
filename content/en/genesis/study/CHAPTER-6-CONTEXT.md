# Genesis 6 — Contextual Study Companion
...
Genesis 6:6: YHWH *nacham* (regretted/grieved). Same root as Noach (Noah)'s name-etymology at 5:29 (*nacham* = comfort). The one named "comfort" enters the narrative at the moment of divine "regret." The TT preserves both occurrences of the root literally.

### A5. Creation reversal — "God saw" inverted
**[TEXTUAL — VERIFIED]**

Gen 1: "God saw that good" (6×). Gen 6:5: "YHWH saw that great was the evil." Gen 6:12: "God saw the land, and see, it was corrupt." Same verb (*ra'ah*), inverted evaluation. The creation-evaluation formula is reversed.
...
Genesis 6:18: "I will establish my covenant (*beriti*) with you." This is the first time the word *berit* (covenant, a binding agreement) appears in the Bible. The TT flags this with 🔴 CRITICAL. The covenant is announced **before** its terms are laid out (those come at 9:8-17). God commits before explaining.

### A8. "Two from all" vs. "seven pairs" — tension preserved
**[TEXTUAL — VERIFIED]**

Gen 6:19: "two from all," one pair per kind. Gen 7:2: "from the clean livestock, seven seven," seven pairs of clean animals. The TT translates both as the MT (the standard Hebrew text) reads them without harmonization per Rule 22 and the No-Harmonization Principle. This is the most visible internal tension in the flood narrative.

### A9. Tebah — a box, not a ship
**[TEXTUAL — VERIFIED]**

The Hebrew *tebah* describes a sealed container with no rudder, sail, or navigation. The same word appears only one other place: Exodus 2:3,5, Moses' basket. Both are sealed containers entrusted to water and to divine providence.

### A10. Kopher/kippur wordplay — covering that saves
**[TEXTUAL — VERIFIED]**

Gen 6:14: the tebah is covered (*kaphar*) with *kopher* (pitch). Root כ-פ-ר (*k-p-r*) = cover/atone, the same root as *kippur* (as in Yom Kippur). The covering that seals the ark against flood-death shares the root of the covering that atones for sin. The TT flags this wordplay per Rule 14.

### A11. YHWH vs. Elohim distribution in Gen 6
**[TEXTUAL — VERIFIED]**

vv.1-8: **YHWH** (narrator describes divine emotional response, regret and grief). vv.9-22: **Elohim/God** (narrator describes divine instructions to Noach (Noah), covering covenant, ark, and animals). The alternation is a textual feature. The TT preserves it without importing documentary-hypothesis framing.
...
- **1 Enoch 6-16 (Book of Watchers, 3rd c. BCE):** 200 angels called Watchers descend on Mount Hermon, take human wives, produce giant offspring
...
**Source:** Charles, R.H., *Book of Enoch*, 1912; Milik, J.T., Dead Sea Scrolls publications, 1971.

### B3. Mesopotamian flood narratives — the closest ANE parallels
**[COMPARATIVE PARALLEL — VERIFIED]**

Three layered traditions:
1. **Ziusudra** (Sumerian, c. 2100-2000 BCE): earliest written flood account, fragmentary
2. **Atrahasis** (Old Babylonian, c. 1800 BCE): flood as divine response to human noise disturbing gods
3. **Utnapishtim** (Gilgamesh Tablet XI, c. 1300-1000 BCE): discovered by George Smith in 1872

Genesis shares: divine decision to destroy, one man warned, vessel built, animals aboard, birds sent out, sacrifice after. Genesis differs: the cause is moral corruption (*chamas*), not divine annoyance at noise. The vessel is a box (*tebah*), not a boat.

**Source:** Finkel, I., *The Ark Before Noah*, 2014; Pritchard, J.B., *ANET*, 3rd ed., 1969.

### B4. Ark dimensions across traditions
**[COMPARATIVE PARALLEL — VERIFIED]**

| Feature | Noah's Tebah (Genesis) | Utnapishtim's Boat (Gilgamesh) | Atrahasis Ark Tablet |
|---------|----------------------|-------------------------------|---------------------|
| Shape | Rectangular (300×50×30 cubits) | Cube (180 ft each side) | Round coracle (230 ft) |
| Deck area | ~15,000 sq cubits | ~14,400 sq cubits | ~14,400 sq cubits |
| Waterproofing | Pitch (*kopher*) | Bitumen | Bitumen |
| Decks | 3 levels | 6 decks | Multiple |

The near-identical deck areas (~4% difference) across all three traditions suggests a shared source tradition for the vessel's scale.

**Source:** Finkel, I., *The Ark Before Noah*, 2014.
...
- **Woolley at Ur (1929):** Clean flood layer below habitation, c. 3500 BCE. Too early and too localized to be "the" flood
...
- **Kish flood layer:** c. 3000-2900 BCE, chronologically closer to the legendary period

Multiple scholars conclude the flood traditions likely originate in devastating but regional Euphrates/Tigris floods c. 2900-2800 BCE.

**Black Sea Deluge Hypothesis (SPECULATIVE):** Ryan and Pitman (Columbia, 1997) proposed that Mediterranean water catastrophically broke through the Bosporus (the narrow strait connecting the Mediterranean to the Black Sea) c. 5600 BCE. Remains highly controversial; dating too early for Mesopotamian traditions.

**Source:** NCSE, "The Flood: Mesopotamian Archaeological Evidence"; Ryan & Pitman, *Noah's Flood*, 1999.

### C2. Covenant (*berit*) in ANE treaty traditions
**[HISTORICAL / ARCHAEOLOGICAL — VERIFIED]**

Mendenhall (1954) showed that biblical covenants follow the same structure as Hittite treaties (formal agreements between a great king and a lesser ruler, 2nd millennium BCE): preamble, historical background, terms, storage instructions, witnesses, blessings/curses. Gen 6:18 initiates the covenant concept; Gen 9:8-17 develops it with rainbow sign.
...
Genesis 6:8: "Noach (Noah) (*nun-chet*) found chen (*chet-nun*) in the eyes of YHWH." The name and the word for "favor/grace" are spelled with the same two Hebrew letters, but in reverse order. Whether this is deliberate wordplay or coincidence is POSSIBLE but unprovable.

### G2. Noach's silence
**[TEXTUAL — VERIFIED]**

God speaks to Noach (Noah) at length (6:13-21). Noah's response: "And Noah did according to all that God commanded him; so he did" (6:22). No recorded speech from Noah until 9:25, the curse of Canaan. His first words are a curse. The silence is textually present and narratively striking.

### G3. 120 years — lifespan or countdown?
**[TEXTUAL — POSSIBLE]**

Gen 6:3: "his days shall be 120 years." Two readings: (1) a future human lifespan limit (but post-flood patriarchs live longer); (2) a 120-year grace period before the flood arrives. Neither is definitively supported; the text is ambiguous.
...
The dating of Genesis's composition is debated. This section presents "the world at the time" for each major scenario, so readers holding any position can see the historical context that would apply to Genesis 6's account of widespread violence, divine-human boundary transgression, flood announcement, boat-building instructions, and first covenant language. The TT does not take sides on when Genesis was composed. For the full 10-category political, economic, and social context of each scenario, see the Genesis 1 companion, Section I.
...
| Smith, M.S., *Origins of Biblical Monotheism*, Oxford, 2001 | Secondary (divine council) | B1 |
| Heiser, M., *The Unseen Realm*, Lexham, 2015 | Secondary (divine council) | B1 |
| Charles, R.H., *Book of Enoch*, 1912 | Primary (Pseudepigrapha) | B2 |
| Milik, J.T., Dead Sea Scrolls publications, 1971 | Primary (DSS) | B2 |
| Finkel, I., *The Ark Before Noah*, 2014 | Secondary (ANE ark) | B3, B4 |
| Pritchard, J.B., *ANET*, 3rd ed., 1969 | Primary (ANE texts) | B3 |
| Mendenhall, G., "Covenant Forms," *BA* 17, 1954 | Article (covenant) | C2 |
| Ryan, W. & Pitman, W., *Noah's Flood*, 1999 | Secondary (geology) | C1 |
| NCSE, "Mesopotamian Archaeological Evidence" | Reference | C1 |
