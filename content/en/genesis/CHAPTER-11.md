...
- [Glossary — Genesis 11](#glossary---genesis-11)
- [Cross-Chapter Tracking (Gen 10 → Gen 11)](#cross-chapter-tracking-gen-10--gen-11)
...
**What happens:** All the land has one lip and one *set of* words. Humanity migrates eastward to the plain of Shinar, where they decide to build a city and a tower with its top in the skies, to "make a name" for themselves and avoid being scattered. YHWH comes down to see the city and the tower, observes that "nothing will be withheld from them," confuses their lip, and scatters them — the very outcome they feared. The city is called Babel, because there YHWH confused (balal) the lip of all the land. Then the genealogy of Shem traces ten generations with declining lifespans: Shem → Arpakhshad → Shelach → Ever → Peleg → Re'u → Serug → Nahor → Terah → Abram. Terah's account introduces Abram, Nahor, and Haran; records Haran's death in Ur of the Kasdim; notes Sarai's barrenness; and ends with Terah taking the family from Ur toward Kenaan — but settling in Charan, where Terah dies.

**Key themes:** Human unity and divine disruption; the "let us" of humanity (11:3–4) mirroring and inverting the "let us" of God (1:26); the ironic reversal — they build to avoid scattering and are scattered; the Babel/confuse (Bavel/balal) wordplay; the tower "in the skies" (the same word as Gen 1:1); "name" (shem) as both the builders' goal and the personal name Shem; the genealogy as bridge from primeval to patriarchal; declining lifespans signaling a changing world; Sarai's barrenness as a narrative problem that will drive Gen 12+.

**Watch for:** "come/let us" appears three times — twice from the humans (11:3, 11:4) and once from YHWH (11:7), structurally mirroring the human initiative; "YHWH came down" (11:5) — anthropomorphic language (describing God using human actions and physical movement): the tower that reaches the skies still requires God to *descend* to see it; the shift from the generic "God" (genealogy) to YHWH (the Babel narrative) follows the established divine-name pattern; Peleg's name means "division" (10:25) — his generation is when the land was divided; the genealogy formula matches Gen 5 but drops "and he died" from most entries.

**Connection:** The scattering at Babel distributes the nations listed in the table of nations (Ch 10). Abram's call (Gen 12:1–3) directly answers the Babel crisis: where humanity sought to "make a name" for themselves and was scattered, God will "make great" Abram's name and through him bless "all the families of the ground." The journey from Ur to Kenaan, left incomplete in 11:31, resumes in 12:4–5.
...
¹²And Arpakhshad lived thirty-five years, and he begot Shelach. ¹³And Arpakhshad lived after he begot Shelach four hundred and three years, and he begot sons and daughters.

¹⁴And Shelach lived thirty years, and he begot Ever. ¹⁵And Shelach lived after he begot Ever four hundred and three years, and he begot sons and daughters.

¹⁶And Ever lived thirty-four years, and he begot Peleg. ¹⁷And Ever lived after he begot Peleg four hundred and thirty years, and he begot sons and daughters.

¹⁸And Peleg lived thirty years, and he begot Re'u. ¹⁹And Peleg lived after he begot Re'u two hundred and nine years, and he begot sons and daughters.
...
>
> 🟢 **"ONE WORDS" (*devarim achadim*)**
> - *Achadim* can mean "one" (unified), "same," or "few." "One words" — the plurality of *devarim* (words) with the unity of *achadim* (one/same) creates a deliberate tension: many words, one system. The TT renders "one *set of* words" — *set of* is added for grammar (Rule 11, italicized).
...
>
> 🟢 **"VALLEY" (*biq'ah*)**
> - **בִּקְעָה** = valley, broad plain, cleft. Not a mountain — a low place. They descend into a plain, then build upward.
>
> 🟢 **"SHINAR"**
> - **שִׁנְעָר** = Shinar, the region of Mesopotamia. Identified with Babylonia. Appears in Gen 10:10 (Nimrod's kingdom) and Dan 1:2.
...
>
> 🟢 **"BRICKS" (*levenim*) AND "BURN THOROUGHLY" (*nisrephah li-serephah*)**
> - **לְבֵנִים** (*levenim*) = bricks, from root *lavan* (white). **נִשְׂרְפָה לִשְׂרֵפָה** = "let us burn *them* to a burning" — a cognate accusative construction emphasizing thoroughness. Mesopotamian building materials: bricks and bitumen replace the stone and mortar of Canaan. The narrator explains the substitution — a note for an audience familiar with stone construction.
>
> 🟢 **"BITUMEN" (*chemar*)**
> - **חֵמָר** = bitumen, tar. Same material used on the tebah (Gen 6:14, where *kopher* is used — but bitumen is the Mesopotamian equivalent). Natural asphalt deposits in the Shinar/Babylonian region.
...
>
> 🔴 **"ITS TOP IN THE SKIES" (*rosho va-shamayim*)**
...
>
> 🔵 **"SONS OF THE HUMAN" (*benei ha-adam*)**
> - **בְּנֵי הָאָדָם** = "sons of the human" — i.e., humanity. The phrase emphasizes their creatureliness. They are *adam* — ground-creatures — building toward the *shamayim*.
...
>
> 🔵 **"THIS IS WHAT THEY BEGIN TO DO" (*zeh hachillam la'asot*)**
> - **זֶה הַחִלָּם לַעֲשׂוֹת** = "this *is what* they begin to do." *Hachillam* — hiphil infinitive of *chalal* (begin). This is only the beginning. YHWH's speech assesses the trajectory, not just the present act.
...
>
> 🔵 **"WILL NOT HEAR" (*lo yishme'u*)**
> - **לֹא יִשְׁמְעוּ** = "will not hear/understand." *Shama* means both "hear" and "understand/obey." The confusion of lip results in the failure of *shama* — they will hear sounds but not understand meaning.
...
>
> 🔵 **"THEY CEASED" (*vayyachdelu*)**
> - **וַיַּחְדְּלוּ** = "and they ceased/stopped." The city is left unfinished. The tower is never completed. The text moves on without describing what remains.
...
>
> 🔵 **DOUBLE ENDING**
> - The verse ends with two parallel clauses: "YHWH confused the lip" + "YHWH scattered them." Confusion and scattering — the two consequences of the Babel event — close the narrative.
...
> - **שְׁנָתַיִם אַחַר הַמַּבּוּל** = "two years after the flood." This creates an arithmetic tension: if Shem was 100 two years after the flood, and Noach was 600 at the flood (7:6), then Noach was 502 when Shem was born — but 5:32 says Noach was 500 when he begot Shem. The two-year discrepancy is noted, not resolved.
...
And Arpakhshad lived thirty-five years, and he begot Shelach.

---

### **Verse 13**

And Arpakhshad lived after he begot Shelach four hundred and three years, and he begot sons and daughters.
...
And Re'u lived thirty-two years, and he begot Serug.

---

### **Verse 21**

And Re'u lived after he begot Serug two hundred and seven years, and he begot sons and daughters.
...
>
> 🟢 **"UR OF THE KASDIM" (*Ur Kasdim*)**
> - **אוּר כַּשְׂדִּים** = Ur of the Kasdim (Chaldeans). Ur is the Sumerian city in southern Mesopotamia. *Kasdim* = Chaldeans — an anachronistic designation (the Chaldeans emerge later), applied retrospectively to identify the location for the audience.
...
## GLOSSARY — GENESIS 11 (additions to Gen 1–9 glossary)

| Hebrew | English | Notes |
|--------|---------|-------|
| שָׂפָה | lip | "One lip" = one language/speech. Body-metaphor preserved per Rule 1. |
| בָּלַל | confuse/mix | Root of *Bavel* wordplay. "YHWH confused the lip." |
| בָּבֶל | Bavel | Babel/Babylon. Folk etymology from *balal*; Akkadian *bab-ili* = "gate of god." |
| מִגְדָּל | tower | *Migdal*. The tower of Babel — "its top in the skies." |
...
| עֲקָרָה | barren | Sarai's condition (11:30). Drives the Abrahamic narrative. |
| חָרָן | Charan | City in upper Mesopotamia. Distinct from הָרָן (Haran the person). |

---

## CROSS-CHAPTER TRACKING (Gen 10 → Gen 11)

**"Let us" (*na'aseh* / *havah*) chain in Genesis:**

| Reference | Speaker | Words | Purpose |
|-----------|---------|-------|---------|
| Gen 1:26 | God | "Let us make (*na'aseh*) a human in our image" | Creation |
| Gen 11:3 | Humans | "Come (*havah*), let us make bricks" | Construction |
| Gen 11:4 | Humans | "Come (*havah*), let us build... let us make (*na'aseh*) a name" | Self-elevation |
| Gen 11:7 | YHWH | "Come (*havah*), let us go down... let us confuse" | Disruption |

The human "let us" appropriates the form of the divine "let us" — and is answered by it. Creation (1:26), imitation (11:4), disruption (11:7).

**Scattering and filling — the mandate resisted:**

| Reference | Command/Action |
|-----------|---------------|
| Gen 1:28 | "Fill the land" |
| Gen 9:1 | "Fill the land" (renewed) |
| Gen 9:19 | "From these the whole land was spread abroad" |
| Gen 11:4 | "Lest we be scattered over the face of all the land" (resistance) |
| Gen 11:8–9 | "YHWH scattered them over the face of all the land" (enforcement) |

The divine mandate to fill/spread is resisted at Babel and enforced by YHWH. Scattering is not punishment — it is the fulfillment of the original command by other means.

**Genealogy comparison — Gen 5 vs. Gen 11:**
...
**Shem (*shem*) — name wordplay:**
- 6:4: "men of the name (*shem*)" — the pre-flood mighty ones
...
**END OF GENESIS 11 — THE TRANSPARENT TRANSLATION (ENGLISH)**
