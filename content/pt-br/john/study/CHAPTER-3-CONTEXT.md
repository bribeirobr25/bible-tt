# João 3 — Companheiro Contextual de Estudo
...
**Companheiro de:** `pt-br/john/CHAPTER-3.md` (Edição Transparente)
**Conjunto de Regras:** v3.3 (Regra 29 governa este arquivo)
**Status:** provisório

---

## A. Características do Texto Grego Expostas pela TT
...
**[HISTÓRICO / ARQUEOLÓGICO — INCERTO]**
...
| Fonte | Tipo | Seções |
|-------|------|--------|
| Nestle-Aland, *Novum Testamentum Graece*, 28ª ed. rev. (Deutsche Bibelgesellschaft, 2012) | PRIMARY | Todas |
| BHS, 5ª ed. rev. (Deutsche Bibelgesellschaft, 1997) | PRIMARY | B2 |
| LXX (Rahlfs-Hanhart, *Septuaginta*, ed. rev., Deutsche Bibelgesellschaft, 2006) | PRIMARY | A3, B2 |
| BDAG (Danker, Bauer, Arndt, Gingrich), *A Greek-English Lexicon of the New Testament*, 3ª ed., University of Chicago Press, 2000 | PEER-REVIEWED (lexicon) | A1, A3, A4, D1, D2 |
...
| Strack, H.L. e Billerbeck, P., *Kommentar zum Neuen Testament aus Talmud und Midrasch*, vol. 2, C.H. Beck, 1924 | PEER-REVIEWED (commentary) | B1 |
...
| Owen, J., *The Death of Death in the Death of Christ*, 1647 (reimpr. Banner of Truth, 1959) | PRIMARY | F3 |
