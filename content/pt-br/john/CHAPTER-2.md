...
| πιστεύω (*pisteuō*) | confiar / confiar-se | Mesmo verbo para ambas as direções — multidão confia em Jesus, Jesus não se confia. |
| ἐγείρω (*egeirō*) | levantar | Abrange tanto reconstrução (estrutura) quanto ressurreição (corpo). |
| ὥρα (*hōra*) | hora | Termo técnico em João: o tempo designado da morte e glorificação de Jesus. |
...
| γυνή (*gynē*) | mulher | Vocativo *gynai* = tratamento formal. Usado para a mãe de Jesus e na cruz. |
...
|-----|-----------|----------|
| Dia 1 | Luz criada (1:3–5) | Testemunho de Yochanan (João) (1:19–28) |
...
| Dia 4 | Luminares (1:14–19) | "No dia seguinte" — Philippos (Filipe), Nathanael (Natanael) (1:43–51) |
...
| Agente | Palavra/comando de Deus | Palavra/comando de Yeshua (Jesus) |
...
| Local | Um pilar de pedra em Beyt-El | O templo em Yerushalayim (Jerusalém) |
| Reivindicação | Yaakov identifica um lugar como habitação de Deus | Jesus identifica o templo como a casa de seu Pai |
| Autoridade | Yaakov nomeia o local | Jesus reivindica autoridade filial sobre o local |
