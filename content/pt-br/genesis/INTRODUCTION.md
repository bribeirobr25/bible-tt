...
> **Esta introdução fornece contexto acadêmico sobre o livro de Gênesis. Não redefine, expande ou controla a tradução principal. Paralelos não provam dependência. Modelos modernos não definem intenção antiga. Todas as entradas são rotuladas por tipo e certeza e devem ser lidas como contexto, não como tradução.**

---

**Livro:** Gênesis (בְּרֵאשִׁית, *Bereshit* — "No princípio")
**Idioma:** Português Brasileiro
**Introdução para:** `pt-br/genesis/` (Edição Transparente)
...
**Princípio de leitura:** Comece pelas entradas TEXTUAL — essas vêm do próprio hebraico. Depois explore para fora, em direção a paralelos, recepção e comparação. A introdução apresenta; você avalia.
...
Gênesis é o primeiro livro da Torá (Pentateuco) e da Bíblia Hebraica (Tanakh). Seu título hebraico בְּרֵאשִׁית (*Bereshit*) é extraído de sua palavra de abertura, significando "no princípio de." Seu título em português "Gênesis" deriva do grego Γένεσις (*Genesis*, "origem, vir a ser"), que é a tradução da Septuaginta (a antiga tradução grega da Bíblia Hebraica, frequentemente abreviada LXX) para o tema do livro, e não uma tradução de seu nome hebraico.
...
Na sequência canônica, Gênesis precede Êxodo e fornece o contexto para a presença de Israel no Egito. O livro termina com a família de Jacó instalada em Gósen (Gn 46–50), e Êxodo 1:1–7 retoma exatamente desse ponto. Dentro da estrutura de cinco livros da Torá, Gênesis é o único livro que não contém legislação sinaítica. Sua relação com os outros quatro livros é de fundamento narrativo: responde quem é Israel, como chegaram ao Egito e quais promessas sustentam a aliança que Êxodo–Deuteronômio irá elaborar.
...
Gênesis se divide em duas grandes seções que diferem em escopo, estilo e mundo narrativo:
...
A frase recorrente אֵלֶּה תוֹלְדוֹת (*ʾelleh toledot*, "estas são as gerações de" ou "este é o relato de") aparece ao longo de Gênesis e funciona como marcador estrutural. A palavra תוֹלְדוֹת (*toledot*) significa "gerações" ou "descendências" — o que é gerado ou produzido a partir de um dado ponto de partida. Cada ocorrência introduz uma nova seção narrativa ou genealógica.
...
## B. Autoria e Composição

### B1. O que o próprio texto diz
**[TEXTUAL — VERIFICADO]**

Gênesis não nomeia seu autor. Nenhum versículo em Gênesis atribui sua composição a qualquer indivíduo. Este é um fato textual, não um argumento a favor ou contra qualquer teoria de autoria. Em outras partes do Pentateuco, certas passagens se referem a Moisés escrevendo textos específicos (Êx 17:14; 24:4; 34:27; Nm 33:2; Dt 31:9, 22, 24), mas nenhuma dessas referências diz respeito a Gênesis. O livro em si é anônimo.

### B2. Atribuição tradicional a Moisés
**[RECEPÇÃO POSTERIOR — DOCUMENTADO]**

A atribuição de Gênesis (e de todo o Pentateuco) a Moisés é uma tradição pós-bíblica, não uma afirmação feita dentro do próprio Gênesis. Principais testemunhos dessa tradição:
...
Observações que complicam a autoria mosaica simples foram notadas por leitores pré-modernos:
...
A partir da observação de Astruc sobre os nomes divinos, estudiosos do século XIX desenvolveram modelos de crítica das fontes do Pentateuco. A formulação clássica:
...
**Modelos atuais divergem significativamente:** **[PARALELO COMPARATIVO — PROVÁVEL]**

- **Modelos suplementares** (Blum, Carr): Um documento-base foi progressivamente suplementado, em vez de quatro fontes independentes sendo mecanicamente unidas. Enfatiza o crescimento editorial sobre a separação de fontes.
...
Diversas observações sobre a composição de Gênesis são amplamente (embora não universalmente) aceitas em todo o espectro acadêmico:
...
Datar a composição de Gênesis é inseparável da questão pentateucal mais ampla. Modelos propostos:
...
O arco temporal narrado de Gênesis abrange dois domínios distintos:
...
Gênesis narra eventos dentro de um mundo que compartilha características com o antigo Oriente Próximo mais amplo. Esses paralelos não provam dependência em nenhuma direção — indicam um ambiente cultural compartilhado.
...
Se Gênesis contém material de diferentes períodos, três eras candidatas são propostas com mais frequência:
...
Gênesis retrata diversas formas de organização social e política:
...
Gênesis se envolve com questões que eram ativas em todas as culturas literárias do antigo Oriente Próximo, embora as aborde de forma narrativa e concreta, e não abstrata ou sistemática:
...
O texto hebraico de Gênesis foi transmitido por uma cadeia de cópia e cuidado editorial que se estendeu por mais de dois milênios:

- Composição (data incerta)
- Tradições orais e/ou escritas
- Compilação editorial (período pré-exílico ao período persa)
- Cópias do período do Segundo Templo (séc. III a.C. – séc. I d.C.):
  - Manuscritos do Mar Morto (Qumran, ca. 250 a.C. – 68 d.C.)
  - Tradição do Pentateuco Samaritano (diverge ca. séc. II a.C.)
  - Tradução da Septuaginta (séc. III a.C., a partir de uma Vorlage hebraica)
- Padronização proto-masorética (séc. I–II d.C.)
- Tradição masorética (séc. VI–X d.C.):
  - Códice de Alepo (ca. 930 d.C.)
  - Códice de Leningrado (1009 d.C.) → BHS → edições críticas padrão
...
A Tradução Transparente trabalha a partir do Texto Masorético (TM) conforme representado na *Biblia Hebraica Stuttgartensia* (BHS), baseada no Códice de Leningrado (B19A, datado de 1009 d.C.). Os massoretas (séc. VI–X d.C.) não compuseram o texto — preservaram e anotaram uma tradição consonantal que já era antiga. Suas contribuições incluem:
...
Descobertas-chave que moldaram a evidência textual para Gênesis:
...
Na biblioteca de Qumran, Gênesis aparece em rolos que contêm apenas Gênesis, consistente com os limites práticos do comprimento de um rolo (um rolo contendo o Pentateuco inteiro seria impraticável). No entanto, não há evidência de que Gênesis tenha circulado como obra literária independente, separada da Torá. A comunidade de Qumran tratava a Torá como uma coleção unificada de cinco livros, assim como todas as comunidades judaicas conhecidas do Segundo Templo.
...
O cânone da Bíblia Hebraica utilizado como texto-base da TT (BHS / Texto Masorético) reflete o cânone rabínico judaico, seguido também pelo protestantismo. Outras tradições cristãs incluem livros adicionais: os cânones católico e ortodoxo oriental incluem os livros deuterocanônicos (Tobias, Judite, Sabedoria de Salomão, Eclesiástico/Sirácide, Baruque, 1–2 Macabeus, acréscimos a Ester e Daniel). O cânone mais amplo da Igreja Ortodoxa Etíope Tewahedo inclui adicionalmente *1 Enoque*, *Jubileus* e vários outros textos. "O que conta como Bíblia" não está definido de forma uniforme em todo o cristianismo global. A literatura pseudepigráfica (textos antigos escritos sob nomes assumidos, como *Vida de Adão e Eva*, *1 Enoque*, *Caverna dos Tesouros*) é amplamente lida em contextos acadêmicos e populares, mas não é canônica na maioria das tradições. Para leitores que desejam se engajar diretamente com esses textos, as edições acadêmicas padrão com revisão por pares são Charlesworth, *The Old Testament Pseudepigrapha* (Doubleday, 1983–85), Nickelsburg-VanderKam, *1 Enoch* (Fortress Press, 2004), e Stone-Anderson, sinopse da literatura de Adão e Eva (SBL, 1999).

---

## F. Lendo Gênesis na TT

### F1. Regras ativas com aplicações específicas para Gênesis
**[TEXTUAL — VERIFICADO]**

As seguintes regras do conjunto de regras da TT (v3.3) têm relevância particular para Gênesis:
...
## G. Fontes Consultadas

| Fonte | Tipo | Seções |
|--------|------|----------|
| Wenham, G. J. *Genesis 1–15* (WBC, 1987) | Comentário | A, B, C, F |
| Wenham, G. J. *Genesis 16–50* (WBC, 1994) | Comentário | A, D |
| Westermann, C. *Genesis 1–11* (CC, 1984) | Comentário | A, B, D |
| von Rad, G. *Genesis* (OTL, 1961) | Comentário | A, D |
| Speiser, E. A. *Genesis* (AB, 1964) | Comentário | A, B |
| Wellhausen, J. *Prolegomena zur Geschichte Israels* (1878) | Crítica das fontes | B |
| Blum, E. *Studien zur Komposition des Pentateuch* (1990) | Crítica das fontes | B |
| Baden, J. *The Composition of the Pentateuch* (2012) | Crítica das fontes | B |
| Schmid, K. *The Old Testament: A Literary History* (2012) | História literária | B, C |
| Schmid, K. *Genesis and the Moses Story* (2010) | Composição | B, C |
| Römer, T. *The Invention of God* (2015) | História da religião | C, D |
| Carr, D. *Reading the Fractures of Genesis* (1996) | Análise literária | A, B |
| Rendtorff, R. *The Problem of the Process of Transmission* (1990) | Transmissão | A, B |
| Thompson, T. L. *The Historicity of the Patriarchal Narratives* (1974) | Historicidade | C |
| Millard, A. and Wiseman, D. J. eds. *Essays on the Patriarchal Narratives* (1980) | Historicidade | C |
| Cross, F. M. *Canaanite Myth and Hebrew Epic* (1973) | Paralelos do antigo Oriente Próximo | A, D |
| Dalley, S. *Myths from Mesopotamia* (1989) | Paralelos do antigo Oriente Próximo | D |
| Lambert, W. G. *Babylonian Creation Myths* (2013) | Paralelos do antigo Oriente Próximo | D |
| Hess, R. and Tsumura, D. eds. *I Studied Inscriptions from Before the Flood* (1994) | Paralelos do antigo Oriente Próximo | D |
| Levenson, J. D. *Creation and the Persistence of Evil* (1988) | Teologia | D |
| Tov, E. *Textual Criticism of the Hebrew Bible* (3ª ed., 2012) | Crítica textual | E |
| Ulrich, E. *The Dead Sea Scrolls and the Origins of the Bible* (1999) | Crítica textual | E |
| Leiman, S. Z. *The Canonization of Hebrew Scripture* (1976) | Cânon | B |
| McDonald, L. M. *The Biblical Canon* (2007) | Cânon | B |
| Albertz, R. *Israel in Exile* (2003) | História | D |
| Tengström, S. *Die Toledotformel* (1982) | Estrutura | A |
| Spinoza, B. *Tractatus Theologico-Politicus* (1670) | História da crítica | B |
| Astruc, J. *Conjectures sur les mémoires originaux* (1753) | História da crítica | B |
| Holmstedt, R. "The Restrictive Syntax of Genesis i 1," *VT* 58 (2008) | Sintaxe | F |

---

> **Proveniência editorial:** Redigido por Claude Opus 4.6 (1M context) em 2026-04-28. Ainda não revisado. Esta introdução é um recurso acadêmico provisório governado pela Regra 29 da TT. Todas as afirmações carregam rótulos duplos; nenhuma afirmação deve ser lida como posição teológica ou composicional da TT. A TT traduz o Texto Masorético e não adota nenhuma teoria particular de autoria ou composição.
