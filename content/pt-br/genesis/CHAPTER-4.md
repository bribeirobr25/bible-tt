...
- [Glossário — Gênesis 4](#glossário---gênesis-4)
- [Rastreamento entre Capítulos (Gn 3 → Gn 4)](#rastreamento-entre-capítulos-gn-3--gn-4)
...
> **NOTAS**
>
> 🟢 **JOGO DE PALAVRAS QAYIN / QANAH**
> - **קַיִן** (*Qayin*) = Caim. **קָנָה** (*qanah*) = adquirir/obter. A fala da mulher torna a etimologia explícita: "Eu *qaniti* (adquiri) um homem." Jogo de palavras preservado conforme Regra 14.
>
> 🔴 **"COM YHWH" — AMBÍGUO**
> - **אֶת־יהוה** (*et-YHWH*) — a partícula *et* pode ser: (1) marcador de objeto direto ("Adquiri um homem, *a saber* YHWH" — teologicamente extremo); (2) preposição "com" ("Adquiri um homem com *a ajuda de* YHWH"). A leitura (2) é muito mais comum. A ambiguidade é preservada na tradução com "com YHWH."
>
> 🔵 **"O HUMANO" — ainda ha-adam**
> - O hebraico tem o artigo: *ha-adam*. Continuando a política "o humano" de Gn 2–3. Transição no v.25.
...
>
> 🟢 **HEVEL = VAPOR/SOPRO**
> - **הֶבֶל** (*Hevel*) = "vapor, sopro, efêmero." O nome carrega seu significado — a mesma palavra usada em Eclesiastes para "vaidade/futilidade." Se o nome prenuncia o seu destino é POSSÍVEL mas não resolvido pelo texto.
>
> 🔵 **VOCAÇÕES**
> - "Lavrador do solo" (*oved adamah*) — mesma raiz ע-ב-ד de Gn 2:15 (trabalhar/guardar o jardim) e 3:23 (lavrar o solo). Qayin continua a vocação pós-exílio.
...
>
> 🟢 **OFERTA**
> - **מִנְחָה** (*minchah*) = oferta/presente/tributo. Mais tarde torna-se termo técnico para oferta de cereais (Lv 2). Aqui, simplesmente "oferta."
...
>
> 🔵 **"ARDEU A ELE"**
> - **וַיִּחַר** (*vayyichar*) = "e ardeu" — expressão idiomática para ira (literalmente "ficou quente para ele"). Preservada literalmente.
...
> **NOTAS**
>
> 🔴 **CRÍTICO — PRIMEIRO "PECADO" NA BÍBLIA**
> - **חַטָּאת** (*chatat*) = pecado. Primeira ocorrência. Aqui **personificado** — o pecado "se agacha" (רֹבֵץ *rovets*, particípio descrevendo um animal à espreita). O pecado é apresentado como uma entidade com agência, não um conceito abstrato.
>
...
>
> 🟢 **PRIMEIRA MORTE**
> - **וַיַּהַרְגֵהוּ** (*vayyahargehu*) = "e o matou." A primeira morte na Bíblia é um assassinato. O verbo *harag* = matar (violento, não sacrificial).
...
>
> 🟢 **ARUR — MALDITO**
> - **אָרוּר** (*arur*) = maldito. Em Gn 3, apenas a serpente (3:14) e o solo (3:17) foram amaldiçoados — nunca os humanos. Agora Qayin É maldito. Escalada: criatura → solo → humano.
>
> 🔵 **"DESDE O SOLO"**
> - Qayin é maldito **desde** (*min*) o solo — o próprio solo o rejeita. Sua vocação era "lavrador do solo" (4:2); agora o solo não produzirá para ele (v.12).
...
>
> 🔵 **DUPLO DESLOCAMENTO**
> - **נָע וָנָד** (*na va-nad*) = "errante e fugitivo" — duplicação de raiz (Regra 6). Dois quase-sinônimos intensificando o exílio. Qayin perde tanto a vocação (solo não produz) quanto a localização (errância).
...
> **NOTAS**
>
> 🔴 **AVON — PECADO OU CASTIGO?**
> - **עֲוֹנִי** (*avoni*) = "meu pecado" OU "meu castigo." A palavra hebraica significa tanto a culpa QUANTO sua consequência. Regra 2 — barra preserva ambos: "meu pecado/castigo." Traduções tradicionais escolhem um; a TT preserva a ambiguidade.

---

### **Versículo 14**

Eis que me expulsaste hoje de sobre a face do solo, e da tua face serei escondido, e serei errante e fugitivo sobre a terra, e será *que* qualquer um que me encontrar me matará."
...
> **NOTAS**
>
> 🟡 **O SINAL — NÃO ESPECIFICADO**
> - **אוֹת** (*ot*) = sinal/marca. O texto NÃO diz o que é o sinal — uma marca no corpo? proteção divina? um aviso a outros? Regra 12 — sem falsa precisão; o texto é deliberadamente vago.
>
> 🔵 **PROTEÇÃO DIVINA APESAR DA MALDIÇÃO**
> - Paralelo com 3:21 (Deus veste os humanos expulsos). Mesmo sob maldição e exílio, YHWH provê proteção. O padrão narrativo: transgressão → consequência → provisão protetora.
...
>
> 🟢 **PRIMEIRA CIDADE**
> - O assassino exilado constrói a primeira cidade. O texto não faz avaliação explícita disto — é declarado, não julgado.
...
E Adah deu à luz Yaval; ele foi o pai dos que habitam em tenda e *com* rebanho.

---

### **Versículo 21**

E o nome de seu irmão *era* Yuval; ele foi o pai de todos os que empunham lira e flauta.

---

### **Versículo 22**

E Tsillah, ela também deu à luz Tuval-Qayin, *um* forjador de toda ferramenta cortante de bronze e ferro. E a irmã de Tuval-Qayin *era* Na'amah.
...
> **NOTAS**
>
> 🔴 **CANTO DE LEMEKH — ESTRUTURA POÉTICA**
...
> **NOTAS**
>
> 🔴 **CRÍTICO — ADÃO SE TORNA NOME PRÓPRIO**
> - **אָדָם** (*adam*) aparece aqui **sem artigo** em contexto genealógico/de nomeação. Este é o **ponto de transição** de "o humano" genérico para o nome próprio "Adão." A TT muda para "Adão" deste versículo em diante. Registrado no log editorial (entrada 081).
>
> 🟢 **SHET = "PÔS/COLOCOU"**
> - **שֵׁת** (*Shet*) de **שִׁית** (*shit*) = "pôr/colocar." A fala de Chava torna o jogo de palavras explícito: "Deus *shat* (pôs) para mim outra *zera* (semente)."
>
> 🔵 **"OUTRA SEMENTE"**
> - **זֶרַע אַחֵר** (*zera acher*) = "outra semente." Continua o fio "a semente dela" de 3:15 e 3:20. A linhagem da mulher continua através de Shet após a morte de Hevel.
...
> **NOTAS**
>
> 🔴 **PRIMEIRA INVOCAÇÃO DE YHWH**
> - **אָז הוּחַל לִקְרֹא בְּשֵׁם יהוה** = "Então se começou a invocar o nome de YHWH." O passivo (*huchal*) não especifica quem começou. Este é o primeiro ato registrado de adoração/invocação formal — a linhagem setita invoca YHWH pelo nome.
>
> 🟢 **ENOSH = HUMANO/MORTAL**
> - **אֱנוֹשׁ** (*Enosh*) = "humano, mortal, homem" — outra palavra para humanidade, enfatizando fragilidade/mortalidade (cf. Sl 8:4, 103:15). Jogo de palavras: a linhagem que invoca YHWH é nomeada "mortal."

---

## GLOSSÁRIO — GÊNESIS 4 (adições ao glossário de Gn 1–3)

| Hebraico | Português | Notas |
|----------|-----------|-------|
| קַיִן | Qayin (Caim) | Jogo de palavras com *qanah* (adquirir); primeiro assassino |
| הֶבֶל | Hevel (Abel) | "Vapor, sopro, efêmero" — mesma palavra do Eclesiastes *hevel* |
| חַטָּאת | pecado | Primeira ocorrência Gn 4:7; personificado ("se agacha") |
| עָוֹן | pecado/castigo | Ambíguo — significa tanto a culpa QUANTO sua consequência (4:13) |
| מִנְחָה | oferta | Presente/tributo; depois termo técnico para oferta de cereais |
| אוֹת | sinal | Marca/sinal não especificado para Qayin (4:15) |
| שֵׁת | Shet (Sete) | "Pôs/colocou" — jogo de palavras com *shit* (4:25) |
| אֱנוֹשׁ | Enosh | "Humano/mortal" — enfatiza fragilidade |
| לֶמֶךְ | Lemekh (Lameque) | Significado INCERTO; escalada da reivindicação de violência |

---

## RASTREAMENTO ENTRE CAPÍTULOS (Gn 3 → Gn 4)

**Retorno de teshuqah:**
- 3:16: *"para o teu homem será o teu desejo/inclinação, e ele dominará sobre ti"*
- 4:7: *"para ti é o seu [do pecado] desejo/inclinação, mas tu deves dominar sobre ele"*
- Estrutura idêntica. Mesma palavra rara (*teshuqah*, 3× no total na BH). Mesmo verbo (*mashal*, dominar).
...
- 3:14: serpente maldita (*arur*) dentre as criaturas
- 3:17: solo maldito (*arurah*) por causa do humano
- 4:11: Qayin maldito (*arur*) DESDE o solo — o solo o rejeita
- Primeiro humano a ser chamado de *arur* diretamente.
...
- Primeiro conhecimento sexual (v.1)
- Primeiro nascimento (v.1)
- Primeiras vocações (v.2)
- Primeira oferta (v.3)
- Primeiro pecado personificado (v.7)
- Primeiro assassinato (v.8)
- Primeira mentira a Deus (v.9)
- Primeiro humano amaldiçoado (v.11)
- Primeira cidade (v.17)
- Primeira poligamia (v.19)
- Primeiras origens tecnológicas (vv.20-22)
- Primeiro poema (vv.23-24)
- Primeira invocação formal de YHWH (v.26)
- Primeiro uso do nome próprio "Adão" (v.25)

---

**FIM DE GÊNESIS 4 — A TRADUÇÃO TRANSPARENTE (PORTUGUÊS BRASILEIRO)**
