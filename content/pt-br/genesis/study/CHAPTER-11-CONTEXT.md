# Gênesis 11 — Estudo Contextual Complementar
...
**Companheiro de:** `pt-br/genesis/CHAPTER-11.md` (Edição Transparente)
...
A narrativa de Babel foi recorrentemente usada de maneiras que o texto não sustenta:
...
A datação da composição de Gênesis é debatida. Esta seção apresenta "o mundo na época" para cada cenário principal, de modo que leitores em qualquer posição possam ver o contexto histórico relevante aos temas específicos do Gênesis 11: arquitetura de torres e zigurates, a ideologia da civilização urbana, a diversidade linguística no mundo antigo, padrões de migração e as cidades de Ur e Charan como lugares reais no mapa antigo. Para o panorama político, econômico e social completo de cada período, ver o companheiro de Gênesis 1 (Seção I).
...
| George, A.R., "The Tower of Babel," *AfO* 51, 2005/2006 | Artigo (AOP) | B1 |
| Kramer, S.N., "The 'Babel of Tongues'," *JAOS* 88, 1968 | Artigo (AOP) | B2 |
| Vanstiphout, H., *Epics of Sumerian Kings*, SBL, 2003 | Secundário (AOP) | B2 |
| Jacobsen, T., *The Sumerian King List*, Chicago, 1939 | Secundário (AOP) | B3 |
| Woolley, C.L., *Ur of the Chaldees*, ed. rev., 1982 | Secundário (arqueologia) | C1 |
| Millard, A.R., "Where Was Abraham's Ur?" *BAR* 27, 2001 | Artigo (arqueologia) | C1 |
| Lloyd, S. & Brice, W., "Harran," *AnSt* 1, 1951 | Artigo (arqueologia) | C2 |
| Gadd, C.J., "The Harran Inscriptions," *AnSt* 8, 1958 | Artigo (arqueologia) | C2 |
| Irineu, *Contra as Heresias* III.17.2 | Primário (recepção) | F1 |
| Gregório de Nazianzo, *Oração 41* | Primário (recepção) | F1 |
| Ginzberg, L., *Legends of the Jews*, vol. 1, 1909 | Secundário (recepção) | F2 |
| Westermann, C., *Genesis 1-11*, Continental, 1984 | Comentário | A, B, G |
