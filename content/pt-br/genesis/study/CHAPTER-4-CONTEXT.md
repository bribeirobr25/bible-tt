# Genesis 4 — Estudo Contextual Complementar
...
| Alter, R., *Genesis: Translation and Commentary*, Norton, 1996 | Comentário | A1, D1 |
| Kramer, S.N., *Sumerian Mythology*, 1944/1961 | Secundária (AOP) | B1 |
| ETCSL, Oxford (Electronic Text Corpus of Sumerian Literature) | Primária (Suméria) | B1 |
| Clifford, R.J., *Creation Accounts in the ANE and Bible*, 1994 | Secundária (AOP) | B2 |
| Bar-Yosef, O., "The Natufian Culture," *Ann. Rev. Anthropology*, 1998 | Artigo (arqueológico) | C1 |
| Reynolds, G.S., *The Qur'an and the Bible*, Yale, 2018 | Secundária (Islâmica) | F3 |
| *Bereshit Rabbah* (séc. V d.C.) | Primária (Rabínica) | F1 |
| *Pirke de-Rabbi Eliezer* (séc. VIII d.C.) | Primária (Rabínica) | F1, G1 |
