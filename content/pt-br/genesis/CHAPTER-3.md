...
- [Glossário — Gênesis 3](#glossário---gênesis-3-adições-ao-glossário-de-gn-12)
- [Rastreamento entre Capítulos (Gn 2 → Gn 3)](#rastreamento-entre-capítulos-gn-2--gn-3)
...
*Visualização em prosa do capítulo completo. O texto é idêntico ao Estudo Verso a Verso abaixo — mesma tradução, mesmas adições em itálico, mesmas fórmulas. As quebras de parágrafo seguem o movimento narrativo natural. Veja a seção de Estudo abaixo para as notas de cada versículo.*
...
> - Nota conforme Regra 14: o jogo de palavras não pode ser reproduzido em português; sinalizado aqui e em 2:25.
>
> 🟢 **SERPENTE**
> - **נָחָשׁ** (*nachash*) = "serpente." **NÃO** "Satanás," "o diabo," ou qualquer identificação teológica posterior. O texto hebraico identifica um *animal do campo* (i.e., criatura que Deus fez, conforme continua em v.14). Qualquer leitura demonológica é pós-bíblica.
>
> 🔴 **SERPENTE USA "ELOHIM," NÃO "YHWH ELOHIM"**
> - O narrador usa *YHWH Elohim* (v.1a), mas a serpente diz apenas *Elohim* (v.1b, v.3, v.5). A mulher também usa só *Elohim*. Significância narrativa **POSSÍVEL**: distinção do nome divino mantida pelo autor; diálogo serpente/mulher fora do registro pactual de *YHWH Elohim*.
>
> 🔵 **"DE FATO, DISSE DEUS"**
> - **אַף כִּי־אָמַר אֱלֹהִים** (*af ki amar elohim*)—abertura sintaticamente difícil. Leituras **POSSÍVEIS**: (1) interrogativa "Disse Deus realmente...?"; (2) incrédula "Então Deus disse...!"; (3) condicional "Mesmo que Deus tenha dito...". Ambiguidade preservada.
> - A pergunta da serpente também distorce o mandamento: original (2:16) era "de toda árvore… comendo comerás"; a serpente inverte para "não de toda árvore."
...
> - Aqui a mulher acrescenta **"e não tocareis"** e suaviza a cláusula de morte para **"para que não morrais"** (*pen-temutun*, cláusula consequencial). Nenhum dos acréscimos é fala divina.
> - O texto não avalia essa ampliação; apenas a registra. Preservar; não importar juízo editorial.
>
> 🟢 **A ÁRVORE NO MEIO**
> - Ela diz "a árvore no meio do jardim"—em 2:9 a árvore da vida está "no meio"; a árvore proibida é pareada com ela. Se ela as identifica, confunde ou usa referência imprecisa é **INCERTO**.
...
> - Mesma construção enfática de infinitivo absoluto. A serpente contradiz a palavra divina em máxima força gramatical.
> - Preservado estruturalmente conforme Regra 5. Traduções tradicionais suavizadas ("certamente não morrereis" / "não morrereis com certeza") embaçam o paralelo; evitadas.
...
>
> 🔵 **OLHOS ABERTOS**
> - **וְנִפְקְחוּ עֵינֵיכֶם** (*venifqechu eineikhem*) = nifal passivo "serão abertos." O evento acontece a eles, não por eles. Cumprido em v.7 com a mesma forma verbal.
...
>
> 🟢 **"AO SEU HOMEM COM ELA"**
> - **לְאִישָׁהּ עִמָּהּ** (*le-ishah immah*) = "ao seu homem com ela." O texto diz **עִמָּהּ** (*immah*, "com ela") sem especificar mais sobre o grau de sua presença, consciência ou participação. A expressão é preservada na tradução; a interpretação permanece aberta.
...
>
> 🟢 **CINTAS**
> - **חֲגֹרֹת** (*chagorot*) = "cintos / cintas / coberturas de cintura." Cobertura parcial, não vestimenta completa. Contraste com v.21 onde YHWH Elohim faz *vestes* completas.
...
>
> 🔴 **"AO VENTO DO DIA"**
> - **לְרוּחַ הַיּוֹם** (*le-ruach hayom*) = "ao / para o vento do dia." A tradução tradicional "à viração do dia" é interpretativa (lendo *ruach* como brisa vespertina, portanto fresca). Regra 12 (sem falsa precisão)—traduzir literalmente; explicar na nota que a expressão é tradicionalmente interpretada como horário da brisa vespertina, mas o hebraico diz apenas "vento do dia."
>
> 🟢 **"NO MEIO DA ÁRVORE"**
> - Singular **עֵץ הַגָּן** (*etz hagan*, "a árvore do jardim")—singular coletivo, i.e., cobertura arbórea do jardim. Não uma árvore específica. Singular preservado em português para mostrar a forma hebraica.
...
> - *Apenas a serpente e o solo são amaldiçoados* em Gn 3. O humano e a mulher são repreendidos, mas não chamados *arur*. Preservar essa distinção—a tradição popular a apaga.
>
> 🔵 **"DENTRE TODO GADO"**
> - **מִכָּל־הַבְּהֵמָה** (*mikol habehemah*) = "dentre todo gado"—comparativo ambíguo: (1) "mais amaldiçoada *que* todo gado" (privativo), ou (2) "amaldiçoada *dentre* / *longe de* todo gado" (separativo). Ambos **POSSÍVEIS**; preservar a preposição hebraica literalmente.
...
> - Regra 2: preservado via "ferir/golpear"; não adotar "esmagar" para o primeiro e "ferir" para o segundo (movimento interpretativo tradicional)—o hebraico usa a mesma forma verbal nas duas vezes.
>
> 🟢 **SEMENTE**
...
>
> 🔴 **CRÍTICO - *teshuqah***
> - **תְּשׁוּקָה** (*teshuqah*) = **INCERTO**. "Desejo" tradicional domina; pesquisa recente propõe "inclinação / orientação / impulso para." Raiz **שׁ-ו-ק** (*sh-w-q*). Aparece apenas 3× na Bíblia Hebraica (aqui, 4:7, Ct 7:11).
> - Regra 2: preservar ambas as leituras via barra "desejo/inclinação."
> - O uso paralelo em Gn 4:7 ("a *teshuqah* do pecado é para ti, mas tu deves dominá-lo") colore a interpretação fortemente mas não resolve a ambiguidade hebraica.
>
> 🟢 **"EM FADIGA"**
> - **עִצָּבוֹן** (*itsabon*) / **עֶצֶב** (*etsev*)—"fadiga / dor / sofrimento / labuta." Mesma raiz usada para a mulher e (em v.17) para o humano. A tradução mantém a mesma raiz portuguesa "fadiga" para preservar o eco. Não exclusivamente "dor de parto."
>
> 🟢 **ECO DE RAIZ - *mashal***
> - **מָשַׁל** (*mashal*) = "dominar." Compartilha a raiz **מ-שׁ-ל** (*m-sh-l*) com **מֶמְשֶׁלֶת** (*memsheleth*, "domínio") usado em **Gn 1:16, 1:18** para os dois grandes luminares governando o dia e a noite. Formas gramaticais diferentes (verbo aqui, substantivo lá) — sem violação da Regra 1 — mas o **eco de raiz** conecta a hierarquia nas relações humanas aqui à hierarquia cósmica lá. O texto declara o eco; não o avalia.
...
>
> 🟢 **O SOLO AMALDIÇOADO**
> - **אֲרוּרָה הָאֲדָמָה** (*arurah ha-adamah*) = "maldito *é* o solo." A *adamah* (de onde o *adam* foi tomado, 2:7) recebe a maldição. Jogo de palavras *adam/adamah* ativo novamente.
...
> - O hebraico não diz *de qual* animal, nem se algum animal morreu. Regra 12—sem falsa precisão; não elaborar sobre implicação sacrificial.
...
>
> 🔵 **"CHAMA DA ESPADA QUE SE VOLTA"**
> - **לַהַט הַחֶרֶב הַמִּתְהַפֶּכֶת** (*lahat hacherev hamithapechet*) = "a chama da espada a que-se-volta"—particípio *mithapechet* = "voltando-se / revolvendo-se." Regra 5—preservar a ação contínua do particípio.
>
> 🔴 **SEM "EXPULSÃO DO PARAÍSO"**
> - O hebraico não tem a palavra *paraíso* aqui. *Pardes* (jardim/parque) entra na Bíblia Hebraica apenas muito mais tarde (Ct 4:13, Ec 2:5, Ne 2:8), como empréstimo persa. O versículo diz *jardim de Éden* e nada mais. Não importar vocabulário de "paraíso."

---

## GLOSSÁRIO - GÊNESIS 3 (adições ao glossário de Gn 1–2)

| Hebraico | Português | Notas |
|----------|-----------|-------|
| נָחָשׁ | serpente | Criatura, não Satanás. Regra 3—sem importação demonológica. |
| עָרוּם | astuto / sagaz | Jogo de palavras com *arom* (nu, 2:25, 3:7, 3:10, 3:11). |
| אָרוּר | maldito | Primeira ocorrência Gn 3:14. Só a serpente (3:14) e o solo (3:17) são amaldiçoados neste capítulo. |
| שׁוּף | ferir / golpear | Verbo raro (3× BH). Significado **INCERTO**. Mesma forma para ambas as ações em 3:15. |
| זֶרַע | semente / descendência | Singular coletivo; pode denotar um ou muitos descendentes. |
| תְּשׁוּקָה | desejo / inclinação | **INCERTO**. 3× BH. Regra 2: barra preserva ambiguidade. |
| מָשַׁל | dominar | 3:16—governo funcional, não propriedade. Paralelo a *radah* (1:26, 1:28). |
| עִצָּבוֹן / עֶצֶב | fadiga / dor / sofrimento | Mesma raiz para a mulher (3:16) e o humano (3:17). Preservar eco. |
| חַוָּה | Chava | Nome próprio, 3:20. Tradicional *Eva* aceitável na Edição do Leitor. Jogo de palavras com *chay* (vivente). |
| כְּרוּב | querubim | Figura guardiã composta; transliterado plural *querubins*. |
| לַהַט | chama | 3:24—construto "chama da espada." |

---

## RASTREAMENTO ENTRE CAPÍTULOS (Gn 2 → Gn 3)

**Cadeia de jogos de palavras:**
- 2:25 *arom* (nu) → 3:1 *arum* (astuto) → 3:7, 3:10, 3:11 *arom* (nu)
- 2:7 *adam/adamah* → 3:17 *adam/adamah* amaldiçoada → 3:19 retorno à *adamah* → 3:23 *trabalhar a adamah*

**Inversões de infinitivo absoluto:**
- 2:16 *"comendo comerás"* / 2:17 *"morrendo morrerás"* / 3:4 *"não morrendo morrereis"* (inversão direta da serpente)
- 3:16 *"multiplicando multiplicarei"* (enfático positivo—aplicado à fadiga)

**Continuidade de verbo-de-criação:**
- *asah* (fez)—3:1 (fez todo animal), 3:21 (fez vestes de pele)
- *bara*, *yatzar*, *banah* não reaparecem em Gn 3.

**Distribuição do nome divino:**
- Narrador: *YHWH Elohim* ao longo (vv. 1, 8, 9, 13, 14, 21, 22, 23)
- Serpente & mulher em diálogo: apenas *Elohim* (vv. 1, 3, 5)
- Humano em diálogo com YHWH Elohim: nenhum nome divino usado (vv. 10, 12)

**Artigo em *adam* (conforme Regra 17):**
- Ao longo de Gn 3 predominantemente *ha-adam* (o humano)
- 3:17 e 3:21: *le-adam* sem artigo—sinalizado como zona-de-transição; uso formal como nome próprio se resolve em Gn 4

**Primeiras ocorrências em Gn 3:**
- Primeira fala da serpente (v.1)
- Primeira fala da mulher (vv. 2–3)
- Primeira desobediência (v.6)
- Primeira vergonha/ocultação (v.7)
- Primeiro esconder-se de Deus (v.8)
...
**FIM DE GÊNESIS 3 - A TRADUÇÃO TRANSPARENTE (PORTUGUÊS BRASILEIRO)**
