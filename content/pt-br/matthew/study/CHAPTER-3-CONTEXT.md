# Mateus 3 — Estudo Contextual Complementar
...
**Complemento de:** `pt-br/matthew/CHAPTER-3.md` (Edição Transparente)
...
**Princípio de leitura:** Comece com as entradas TEXTUAIS — essas vêm do próprio grego. Depois explore para fora, até paralelos, recepção e comparação. O complemento apresenta; você avalia.

---

## A. Características do Texto-Fonte Expostas pela TT
...
## B. Paralelos do Segundo Templo e do Antigo Oriente Próximo
...
- **Mikva'ot em Jerusalém:** Dezenas de piscinas de imersão com degraus foram escavadas perto do Monte do Templo, no Bairro Judaico e em residências sacerdotais. Datam dos períodos hasmoneu e herodiano.
...
| Fonte | Tipo | Usada nas seções |
|-------|------|-----------------|
| Davies, W.D. e Allison, D.C., *ICC Matthew*, vol. 1, 1988 | PEER-REVIEWED (commentary) | A, D, G |
...
| Lieberman, S., *Hellenism in Jewish Palestine*, 2ª ed., 1962 | PEER-REVIEWED (monograph) | F |
| Murphy-O'Connor, J., *The Holy Land*, 5ª ed., 2008 | ACADEMIC POPULAR | C |
| Nestle-Aland, *Novum Testamentum Graece*, 28ª ed. | PRIMARY | A |
...
| VanderKam, J., *The Dead Sea Scrolls Today*, 2ª ed., 2010 | PEER-REVIEWED (monograph) | B |
