...
**Livro:** Mateus (Μαθθαῖος, *Maththaios*)
**Idioma:** Português Brasileiro
**Introdução a:** `pt-br/matthew/` (Edição Transparente)
**Conjunto de Regras:** v3.0 (Regra 29 governa este arquivo)
**Status:** provisório
...
Este arquivo contém material de fundo organizado por tópico. Cada entrada carrega **dois rótulos:**

**Que tipo de afirmação?** (indica a fonte da informação)
- **TEXTUAL** -- derivada diretamente do texto grego
- **INFERÊNCIA FORTE** -- logicamente implicada pelo texto, não declarada explicitamente
- **INFERÊNCIA POSSÍVEL** -- uma leitura legítima entre outras
- **PARALELO COMPARATIVO** -- atestada em outra fonte antiga
- **RECEPÇÃO POSTERIOR** -- leitura pós-bíblica
- **HISTÓRICO / ARQUEOLÓGICO** -- baseada em evidência material ou histórica
- **COMPARAÇÃO CIENTÍFICA** -- observação empírica moderna comparada ao texto
- **ESPECULAÇÃO** -- sem base textual ou evidencial forte

**Quão certo?** (indica o nível de confiança)
...
**Princípio de leitura:** Comece com as entradas TEXTUAIS -- essas vêm do próprio grego. Depois explore para fora, até paralelos, recepção e comparação. A introdução apresenta; você avalia.
...
O Evangelho de Mateus é o primeiro livro do cânon do Novo Testamento. É o mais judaico dos quatro Evangelhos -- profundamente enraizado na Bíblia Hebraica, estruturado em torno de citações de cumprimento, e preocupado com a observância da Torá, o papel de Israel e a identidade de Yeshua como o Messias da expectativa judaica. Contém 28 capítulos e aproximadamente 1.071 versículos.

Mateus compartilha material substancial com Marcos e Lucas (o "Problema Sinótico"), mas se distingue por sua estrutura organizacional, sua ênfase em Yeshua como mestre e seu extenso engajamento com as Escrituras Hebraicas. Inclui material ausente dos outros Sinóticos: a genealogia traçando Yeshua através de David até Avraham (1:1-17), a narrativa do nascimento com os sonhos de Yosef e os magos (1:18-2:23), e blocos significativos de material de ensino exclusivos de Mateus.
...
Mateus é organizado em torno de cinco blocos de discurso principais, cada um concluído pela fórmula "e aconteceu que quando Yeshua terminou estas palavras/ditos" (καὶ ἐγένετο ὅτε ἐτέλεσεν ὁ Ἰησοῦς τοὺς λόγους τούτους, ou variante). Esta estrutura quíntupla tem sido amplamente notada desde B. W. Bacon (1918):
...
**Discurso 3 -- Discurso Parabólico (capítulo 13):** Sete parábolas do reino dos céus -- semeador, trigo e joio, grão de mostarda, fermento, tesouro escondido, pérola, rede de arrasto. Ensino sobre por que Yeshua fala em parábolas (13:10-17).
...
**Origens e preparação (1:1-4:16):** Genealogia (1:1-17), narrativa do nascimento (1:18-2:23), ministério de Yochanan o Imersor (3:1-12), imersão e teste de Yeshua (3:13-4:11), retirada para a Galileia (4:12-16).

**Ministério galileu (4:17-16:20):** Ensino e cura públicos, começando com "Desde então Yeshua começou a proclamar" (4:17). Os cinco discursos situam-se primariamente nesta seção. A confissão de Kefa em Cesareia de Filipe (16:13-20) marca um ponto de virada.

**Jornada a Yerushalayim e paixão (16:21-27:66):** Predições da paixão, entrada em Yerushalayim, controvérsias no templo, o discurso escatológico, a última ceia, prisão, julgamento, crucificação, sepultamento.
...
O autor era provavelmente um cristão judeu falante de grego com forte formação escribal, profundo conhecimento das Escrituras Hebraicas (tanto em hebraico quanto nas formas da LXX) e acesso ao Evangelho de Marcos e tradição adicional (Q ou equivalente).
...
- A genealogia (1:1-17) estrutura a linhagem de Yeshua através de Avraham e David -- figuras cujo significado não requer explicação.
...
Composição (c. 80-90 EC)
     ↓
Cópias primitivas (séculos II-III EC)
  ├── P1 (séc. III) -- Mt 1:1-9, 12, 14-20
  ├── P45 (séc. III) -- porções dos quatro Evangelhos + Atos
  ├── P64+67 (final do séc. II) -- Mt 3, 5, 26
  └── P104 (séc. II) -- Mt 21:34-37, 43, 45
     ↓
Códices principais (séculos IV-V EC)
  ├── Códice Sinaítico (א, séc. IV)
  ├── Códice Vaticano (B, séc. IV)
...
| 2:5-6 | Mq 5:2 (+ 2 Sm 5:2) | Beyt-Lechem como local de nascimento |
...
|-------|------|-------------------------------|
| 1 | Diretiva Principal | Não simplificar a estrutura da genealogia (três conjuntos de catorze) nem resolver suas tensões históricas. |
...
| 4 | Sem paráfrase interpretativa | "Reino dos céus" traduzido literalmente, não parafraseado como "reino do céu" ou "reino de Deus." |
| 7 | Preservar campo semântico | *Parthenos* em 1:23 carrega toda sua gama semântica grega (jovem mulher/virgem); notado em vez de colapsado. |
| 11 | Marcar adições gramaticais | Palavras adicionadas para a gramática portuguesa aparecem em itálico. |
| 13 | Níveis de incerteza | Termos debatidos e questões genealógicas carregam rótulos de confiança. |
| 14 | Notas do texto-fonte | Termos gregos-chave preservados em transliteração onde semanticamente significativos. |
| 22 | Sem cabeçalhos interpretativos | Divisões de seção não impõem uma leitura sobre o texto. |
| 25 | YHWH traduzido consonantalmente | Aplicado em contextos de citação do AT conforme a Política do Nome Divino (F5). |
...
| Fonte | Tipo | Seções |
|-------|------|--------|
| Davies, W.D. e Allison, D.C. *A Critical and Exegetical Commentary on the Gospel According to Saint Matthew* (ICC, 1988-1997) | Comentário | A, B, C, D |
| Luz, U. *Matthew* (Hermeneia, 2001-2007) | Comentário | A, B, C |
| Hagner, D.A. *Matthew* (WBC, 1993-1995) | Comentário | B |
| Kingsbury, J.D. *Matthew: Structure, Christology, Kingdom* (1975) | Estrutura/Teologia | A |
| Bacon, B.W. "The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918) | Estrutura | A |
| Stendahl, K. *The School of St. Matthew* (1954) | Composição | B |
