...
**Principio de lectura:** Comience con las entradas TEXTUAL — provienen del griego mismo. Luego explore hacia los paralelos, la recepción y la comparación. La introducción presenta; usted evalúa.
...
**Fuente:** Bacon, "The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918): 56–66; Kingsbury, *Matthew: Structure, Christology, Kingdom* (1975), 1–39.
...
### B1. Lo que dice el texto mismo
**[TEXTUAL — VERIFICADO]**

El Evangelio de Mateo no nombra a su autor. El texto es anónimo — ninguna declaración interna identifica quién lo compuso. El título "Según Mateo" (ΚΑΤΑ ΜΑΘΘΑΙΟΝ) es una adición posterior encontrada en los encabezados de los manuscritos pero no forma parte de la composición original. A diferencia de las epístolas paulinas o el libro de Apocalipsis, el Evangelio no proporciona identificación autoral en primera persona.

El texto sí menciona a "Mateo" (Μαθθαῖος) en 9:9 (el llamado de un recaudador de impuestos llamado Mateo) y 10:3 (que incluye a "Mateo el recaudador de impuestos" entre los doce). El pasaje paralelo en Marcos 2:14 nombra a este recaudador como "Leví hijo de Alfeo." Si "Mateo" y "Leví" son la misma persona, o si el Evangelio de Mateo ha sustituido un nombre por otro, es debatido.
...
- ¿Significa *Hebraidi dialektō* "en la lengua hebrea," "en arameo," o "en estilo hebreo"?
- Si Papías describe un original arameo/hebreo, el Evangelio griego existente no muestra señales de ser una traducción de una fuente semítica — está compuesto en griego fluido y depende del Evangelio griego de Marcos.

Escritores posteriores (Ireneo, *Adv. Haer.* 3.1.1; Orígenes vía Eusebio, *HE* 6.25.4) repiten y elaboran la tradición. Para fines del siglo II, la autoría apostólica era estándar.

**Fuente:** Luz, *Matthew* (Hermeneia), I.47–54; Davies y Allison, *Matthew* (ICC), I.7–17.

### B3. Evaluación moderna
**[PARALELO COMPARATIVO — PROBABLE]**

La mayoría de los académicos contemporáneos dudan que el apóstol Mateo escribiera el Evangelio en su forma actual. Las razones principales:

- **Dependencia de Marcos:** El Evangelio incorpora aproximadamente el 90% del contenido de Marcos, a menudo verbatim en griego. Un testigo ocular directo y apóstol difícilmente dependería tan fuertemente de una fuente no ocular (Marcos se asocia tradicionalmente con el testimonio de Pedro, no con autoridad independiente).
- **Composición en griego:** El Evangelio está escrito en griego competente, no traducido del arameo o hebreo. El testimonio de Papías sobre una composición hebrea/aramea no coincide con el texto existente.
...
Una minoría de académicos argumenta por una fecha pre-70, notando que 22:7 podría ser profético más que retrospectivo y que algunas tradiciones en Mateo pueden reflejar material palestino temprano.

**Fuente:** Davies y Allison, *Matthew* (ICC), I.127–138; Luz, *Matthew* (Hermeneia), I.55–60.

---

## D. Contexto Histórico

### D1. Comunidad judeocristiana post-70
**[HISTÓRICO / ARQUEOLÓGICO — PROBABLE]**
...
### D3. Audiencia — una comunidad fuertemente judía
...
| Códice Vaticano (B) | s. IV e.c. | Mateo completo | Generalmente considerado el manuscrito individual más confiable |
| Códice Bezae (D) | s. V e.c. | Mateo (bilingüe griego-latín) | Testigo importante del tipo textual "occidental" |
...
## F. Leer Mateo en la TT

### F1. "Reino de los cielos"
**[TEXTUAL — VERIFICADO]**

La frase característica de Mateo βασιλεία τῶν οὐρανῶν (*basileia tōn ouranōn*, literalmente "reino de los cielos") aparece aproximadamente 32 veces en el Evangelio — una frase única de Mateo entre los Evangelios. Los pasajes paralelos en Marcos y Lucas usan consistentemente βασιλεία τοῦ θεοῦ (*basileia tou theou*, "reino de Dios"), que Mateo también usa ocasionalmente (12:28; 19:24; 21:31, 43).

La TT traduce esta frase como "reino de los cielos" — una traducción literal del griego plural *ouranōn* que evita la carga teológica del tradicional "reino de los cielos" como expresión fija que en español connota un destino de ultratumba más que el reinado de Dios. La frase probablemente refleja una circunlocución judía por el nombre divino — usando "cielos" para evitar decir "Dios" directamente — pero esto es inferencia, no algo que el texto declare. La TT traduce lo que el texto dice; la hipótesis de la circunlocución pertenece a una nota.

### F2. Nombres transliterados TT en Mateo
**[TEXTUAL — VERIFICADO]**

Según la política de transliteración de la TT, los nombres propios clave en Mateo se traducen desde sus formas originales:
...
La TT traduce cada cita del griego tal como aparece en Mateo (que a veces difiere tanto del TM como de la LXX) y nota la fuente del AT, cualquier divergencia del hebreo, y los movimientos interpretativos involucrados. La traducción no aprueba ni rechaza la afirmación de cumplimiento — traduce lo que el texto dice.

### F4. Parthenos/almah en 1:23
**[TEXTUAL — PROBABLE]**

Mateo 1:23 cita Isaías 7:14 usando la palabra griega παρθένος (*parthenos*, "virgen"). El texto fuente hebreo (Is 7:14) usa עַלְמָה (*almah*), que significa "mujer joven" (en edad de casarse) — un término que no especifica en sí mismo la virginidad. La LXX tradujo *almah* como *parthenos*, y Mateo sigue la lectura de la LXX.

La TT traduce *parthenos* tal como aparece en el texto griego de Mateo (no sustituyendo el hebreo *almah*), pero proporciona una nota documentando:
- La fuente hebrea usa *almah*, no *betulah* (el término hebreo estándar para "virgen").
- La elección de *parthenos* por parte de la LXX ya representa una traducción interpretativa.
- Mateo sigue la lectura de la LXX, no el TM directamente.

Esta es una decisión de traducción, no una posición teológica. La TT documenta la situación textual.
...
### F6. Reglas activas con aplicaciones específicas a Mateo
**[TEXTUAL — VERIFICADO]**
...
|--------|------|-----------|
| Davies, W. D. y Allison, D. C. *A Critical and Exegetical Commentary on the Gospel According to Saint Matthew* (ICC, 1988–1997) | Comentario | A, B, C, D |
| Luz, U. *Matthew* (Hermeneia, 2001–2007) | Comentario | A, B, C |
| Hagner, D. A. *Matthew* (WBC, 1993–1995) | Comentario | B |
| Kingsbury, J. D. *Matthew: Structure, Christology, Kingdom* (1975) | Estructura/Teología | A |
| Bacon, B. W. "The 'Five Books' of Matthew Against the Jews," *The Expositor* 15 (1918) | Estructura | A |
| Stendahl, K. *The School of St. Matthew* (1954) | Composición | B |
...
> **Procedencia editorial:** Redactado por Claude Opus 4.6 (contexto 1M) el 27-04-2026. Sin revisión. Esta introducción es un recurso académico provisional gobernado por la Regla 29 de la TT. Todas las afirmaciones llevan etiquetas duales; ninguna afirmación debe leerse como la posición teológica o composicional de la TT. La TT traduce el texto griego (NA28) y no adopta ninguna teoría particular de autoría o composición.
