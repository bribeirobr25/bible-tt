...
**Temas clave:** La fórmula *toledot* (2:4); YHWH Dios (nombre divino combinado); formación a partir de *adamah* (suelo) — el juego de palabras *adam/adamah*; el jardín como espacio delimitado; el árbol del conocimiento y el árbol de la vida; el mandato y su consecuencia ("muriendo morirás"); nombrar como ordenar; "una sola carne."
...
Y fueron acabados los cielos y la tierra y todo su ejercito.
...
Y Dios acabo en el septimo día su obra que había hecho, y descanso en el septimo día de toda su obra que había hecho.
...
Estas *son* las generaciónes de los cielos y la tierra cuando fueron creados, en el día *que* YHWH Elohim hizo tierra y cielos.
...
> - Raiz **י-ל-ד** (*y-l-d*) = dar a luz; *toledot* literalmente = "engendraciones." El significado se extiende más alla de genealogía a "relato de origen" o "cosas que surgieron."
>
> 🔵 **INVERSION DE ORDEN**
...
> - **NO "alma"** en el sentido filosofico posterior (ver glosario).
...
>
> 🔵 **PARTICIPIO - CONTINUO**
> - **יֹצֵא** (*yotze*) = "saliendo" (participio)--acción continua/habitual, no pasado completado.
...
>
> 🟢 **NOMBRES PROPIOS**
> - **פִּישׁוֹן** (*Pishon*), **חֲוִילָה** (*Havilah*)--transliterados; identificación geografica **INCIERTA** en términos modernos.
...
> **NOTAS**
>
> 🟡 **MATERIALES INCIERTOS**
> - **בְּדֹלַח** (*bedolach*) = "bdelio"--resina vegetal o posiblemente gema; identificación debatida.
> - **שֹׁהַם** (*shoham*) = "piedra shoham"--probablemente onice, cornalina o berilo; identificación **INCIERTA**. Transliterado aquí para evitar falsa precision.
...
>
> 🟢 **CUSH**
> - **כּוּשׁ** (*Kush*) = region al sur de Egipto (actual Sudan/Etiopia), aunque la geografia aquí es debatida.
...
Y YHWH Elohim tomó al humano y lo puso en el jardín de Eden para trabajarlo y para guardarlo.
...
>
> 🔴 **INFINITIVO ABSOLUTO**
> - **אָכֹל תֹּאכֵל** (*akhol tokhel*) = "comiendo comeras"--construcción de **infinitivo absoluto** hebreo usada para enfasis. Versiones suavizadas tradicionales: "podras comer libremente" / "ciertamente comeras."
> - **Preservado estructuralmente** según Regla 5; la rigidez es intenciónal. Emparejado con la contraparte negativa en v.17.
...
>
> 🔴 **NUEVO VERBO - *banah***
> - **וַיִּבֶן** (*vayyiven*) = "y construyó"--raíz **ב-נ-ה** (*b-n-h*), verbo de construcción. El único lugar en las narrativas de creación donde la acción de Dios se describe como **construir**. Distinto de *bara*, *asah*, *yatzar*.
> - Resonancia **POSIBLE**: después, la misma raíz se usa para "construir" arquitectonica y familiarmente (e.g., "edificar una casa" = establecer un linaje).
...
>
> 🔵 **"ESTA VEZ, ESTA VEZ"**
> - **זֹאת הַפַּעַם** (*zot hapa'am*) = "esta *vez*, esta vez"--enfatico; contrasta con los animales de vv. 19-20 que no calificaron.
...
>
> 🔵 **APARTE DEL NARRADOR**
> - Cambio de discurso del personaje (v.23) a comentario del narrador (v.24). Hebreo **עַל־כֵּן** (*al-ken*) = "por tanto / por esta razon"--marcador etiologico explicando una practica presente.
>
> 🟢 **"UNA SOLA CARNE"**
> - **בָּשָׂר אֶחָד** (*basar echad*) = "una *sola* carne"--mismo adjetivo *echad* (uno) que Gen 1:5 *"día uno"*; aquí describe union, no enumeración.
...
## GLOSARIO - GENESIS 2 (adiciones al glosario de Gen 1)

| Hebreo | Español | Notas |
|--------|---------|-------|
| יהוה | YHWH | Tetragrama; Regla 25 Opción A (consonantal); primera ocurrencia v.4 |
| יהוה אֱלֹהִים | YHWH Elohim | Nombre divino compuesto; distintivo de Gen 2-3; nunca colapsado a "Señor Dios" |
| יָצַר | formo | Verbo de alfarero; distinto de *bara* y *asah*; usado para humano (v.7) y animales (v.19) |
| בָּנָה | construyó | Verbo de construcción; usado para la mujer (v.22) solo en Gen 2 |
...
| צֵלָע | lado / costilla | Ambiguedad preservada (Regla 2) |
| תַּרְדֵּמָה | sueno profundo | Sueno inducido divinamente; no trance, no muerte |
| אִישׁ / אִשָּׁה | *ish* / *ishah* | Transliterados en v.23 para preservar juego de palabras |
| עֲרוֹם | desnudo | Juego de palabras con *arum* (astuto, Gen 3:1) |
| אֵד | niebla / corriente *(incierto)* | Palabra rara; aparece solo 2 veces en la Biblia hebrea |

---

## SEGUIMIENTO ENTRE CAPITULOS (Gen 1 - Gen 2)

**Cambio de verbo de creación:**
- Gen 1: *bara* (1:1, 1:21, 1:27), *asah* (1:7, 1:16, 1:25)
- Gen 2 introduce: *yatzar* (2:7 humano, 2:19 animales), *banah* (2:22 mujer)
- Gen 2 también *bara* + *asah* emparejados en 2:3 resumen ("creó para hacer")

**Cambio de género literario según Regla 23:**
- Gen 1: ritmo liturgico, formulas fijas ("Y Dios dijo... y fue así... tarde y mañana...")
...
- Primer YHWH (v.4)
- Primer "no bueno" (v.18)
- Primer discurso humano (v.23)
- Primera santificación / categoria de lo santo (v.3)
- Primer mandamiento (v.16-17)
