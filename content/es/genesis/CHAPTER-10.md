...
- [Glosario — Génesis 10](#glosario---génesis-10)
- [Seguimiento entre Capítulos (Gn 9 → Gn 10)](#seguimiento-entre-capítulos-gn-9--gn-10)
...
**Qué sucede:** Los hijos de Noé — Sem, Cam y Jafet — generan las naciones del mundo conocido. La línea de Jafet (vv.2–5) puebla las costas e islas. La línea de Cam (vv.6–20) incluye a Kush, Egipto, Put y Canaán, y contiene la digresión de Nimrod — un "poderoso" y cazador "ante YHWH" que construye Bavel, Erekh, Akkad, Kalneh, Nínive y otras grandes ciudades. La línea de Sem (vv.21–31) traza desde Arpakhshad hasta Ever (antepasado de los hebreos) e incluye la ramificación Peleg/Yoqtan. El capítulo termina con un resumen: estos son los clanes de los hijos de Noé, por sus generaciones, en sus naciones, y de estos se dispersaron las naciones sobre la tierra después del diluvio.

**Temas clave:** La unidad y diversidad de la humanidad postdiluviana — todos descienden de una familia, pero el texto cataloga la diferenciación por clan, lengua, tierra y nación. La Tabla de las Naciones es etnográfica, no puramente genealógica — traza realidades políticas y geográficas sobre un árbol familiar. La sección de Nimrod introduce la construcción de imperios, la fundación de ciudades y el primer "poderoso" después del diluvio.
...
>
> 🔵 **NOMBRES PLURALES**
> - El sufijo *-im* (plural masculino hebreo) en Kittim y Dodanim señala pueblos colectivos en lugar de antepasados individuales. La forma genealógica aquí es étnica, no biográfica.
...
>
> 🟡 **DIVERSIDAD LINGÜÍSTICA ANTES DE BAVEL**
> - El texto menciona "cada uno por su lengua" — implicando diversidad lingüística. Sin embargo, Gn 11:1 dice "toda la tierra era de un solo labio." La Tabla de las Naciones describe el resultado; la narrativa de Bavel (Cap. 11) explica el mecanismo. Los dos capítulos están en secuencia temática, no cronológica.
...
>
> 🔵 **SUB-RAMIFICACIÓN**
> - La línea de Kush se sub-ramifica a través de Ramah a Sheva y Dedan — y luego a través de Nimrod (v.8) hacia la narrativa mesopotámica. Los descendientes de Kush abarcan desde Arabia hasta Mesopotamia.
...
>
> 🟢 **"PODEROSO" (*gibbor*)**
> - **גִּבּוֹר** (*gibbor*) = poderoso, guerrero, campeón. De la raíz ג-ב-ר (ser fuerte/prevalecer). La misma palabra describe a los *gibborim* de Gn 6:4 — "los poderosos (*gibborim*) que *fueron* desde antiguo, hombres del nombre." Este es el primer *gibbor* postdiluviano. Si el eco es intencional (vinculando a Nimrod con los poderosos prediluvianos) es POSIBLE pero no está declarado.
>
> 🔵 **"ÉL COMENZÓ A SER" (*hejel lihyot*)**
> - **הוּא הֵחֵל לִהְיוֹת** = "él comenzó a ser." El verbo חלל (*jalal*) en Hifil = "comenzar." Nimrod "comenzó" una nueva categoría — el primero en ser un *gibbor* en la tierra postdiluviana.
...
>
> 🔴 **YHWH — ÚNICA APARICIÓN EN EL CAPÍTULO**
> - Esta es la única aparición del nombre divino YHWH en toda la Tabla de las Naciones. En el resto del capítulo no se usa ningún nombre divino. La sección de Nimrod es la única puntuación teológica en una lista por lo demás etnográfica.
>
> 🟢 **"PODEROSO CAZADOR" (*gibbor tsayid*)**
> - **גִּבֹּר צַיִד** = "poderoso *de* caza" / "poderoso cazador." *Tsayid* = caza, presa. La frase se hizo proverbial — el texto mismo registra el proverbio: "por eso se dice..." Esta es una de las primeras citas proverbiales en Génesis.
>
> 🟡 **EL NOMBRE DE NIMROD**
> - El nombre **נִמְרֹד** se conecta frecuentemente con la raíz מ-ר-ד (*marad*) = "rebelarse." Si es así, el nombre significa "nos rebelaremos" o "rebelémonos." Esta es una conexión etimológica popular — POSIBLE pero lingüísticamente incierta. El texto no explica el nombre.
...
>
> 🟢 **IDENTIFICACIONES DE CIUDADES**
> - **Bavel** (בָּבֶל) = Babilonia (bien atestiguada; el juego de palabras hebreo con *balal* = "confundir" aparecerá en 11:9). **Erekh** (אֶרֶךְ) = Uruk (la gran ciudad sumeria; acadio *Uruk*, moderna Warka). **Akkad** (אַכַּד) = Akkad (capital del imperio acadio bajo Sargón). **Kalneh** (כַּלְנֵה) = identificación debatida (INCIERTO; posiblemente Nippur, posiblemente Kullaniya, posiblemente un problema textual).
>
> 🟢 **"TIERRA DE SHINAR" (*eretz Shinar*)**
> - **אֶרֶץ שִׁנְעָר** = Mesopotamia meridional / Babilonia. *Shinar* aparece de nuevo en 11:2 (la narrativa de Bavel) y 14:1. La identificación con Sumer es PROBABLE.
...
>
> 🟢 **IDENTIFICACIONES DE CIUDADES**
> - **Nínive** (נִינְוֵה) = la gran capital asiria (bien atestiguada; zona de la moderna Mosul). **Rejovot-Ir** (רְחֹבֹת עִיר) = "amplios espacios de la ciudad" — ya sea una ciudad separada o una descripción de los suburbios de Nínive (INCIERTO). **Kelaj** (כָּלַח) = Kalah/Kalhu (moderna Nimrud; PROBABLE).
...
>
> 🟢 **IDENTIFICACIONES**
> - **Patrusim** = Alto Egipto / Patros (PROBABLE). **Kaslujim** = incierto. **Kaftorim** = Creta / Caftor (PROBABLE; cf. Dt 2:23, Amós 9:7).
...
>
> 🔵 **"SE DISPERSARON" (*nafotsu*)**
> - **נָפֹצוּ** (*nafotsu*) = "se dispersaron/esparcieron." Misma raíz que 9:19 ("de estos se esparció toda la tierra") y 11:4, 8, 9 (la dispersión en Bavel). El tema de la dispersión recorre Gn 9–11.
...
> - La línea de Ever se divide: Peleg → la línea abrahámica (continuada en 11:18–26). Yoqtan → las tribus árabes (vv.26–29). La narrativa bíblica sigue a Peleg; la línea de Yoqtan se cataloga y luego se deja atrás.
...
>
> 🔵 **"TODOS ESTOS FUERON LOS HIJOS DE YOQTAN"**
> - Trece hijos en total — la familia individual más grande en la Tabla de las Naciones. Todos se asocian con la península arábiga. Esta línea se registra, y luego la narrativa nunca regresa a ella.
...
>
> 🟡 **SETENTA NACIONES**
> - El recuento tradicional arroja 70 nombres en la Tabla de las Naciones (el conteo exacto varía según el método). Setenta es un número estructuralmente significativo en la Biblia hebrea (70 ancianos, Ex 24:1; 70 años de exilio, Jer 25:11; 70 naciones en la tradición judía posterior). Si la lista fue compuesta para totalizar 70 o si esto es coincidencia, se debate.

---

## GLOSARIO — GÉNESIS 10 (adiciones al glosario de Gn 1–9)

| Hebreo | Español | Notas |
|--------|---------|-------|
| תּוֹלְדוֹת | generaciones | Cuarta fórmula *toledot* (10:1). Marcador estructural. |
...
| פֶּלֶג | división (nombre propio) | De la raíz פ-ל-ג (*palag*) = dividir. Juego de palabras en 10:25. |
...
- 10:8–9: Nimrod — "poderoso (*gibbor*) en la tierra," "poderoso cazador ante YHWH." Primer *gibbor* postdiluviano.
- La categoría *gibbor* resurge después del diluvio a través de la línea de Cam.
...
- 10:18: **נָפֹצוּ** (*nafotsu*) — "se dispersaron" (misma raíz)
- 10:25: **נִפְלְגָה** (*niflega*) — "fue dividida" (raíz פ-ל-ג)
- 10:32: **נִפְרְדוּ** (*nifredu*) — "se dividieron/separaron" (raíz פ-ר-ד)
- 11:4: **נָפוּץ** (*nafuts*) — "ser esparcidos" (raíz פ-ו-צ de nuevo)
- Tres raíces distintas describen la dispersión humana a lo largo de Gn 9–11.
...
- **Sheva** = en la línea de Ramah (10:7, Cam) Y en la línea de Yoqtan (10:28, Sem)
- **Ashshur** = hijo de Sem (10:22) Y territorio de la expansión de Nimrod (10:11, a través de Cam)
- Estas superposiciones pueden reflejar complejidad histórica, matrimonios mixtos o reclamos territoriales compartidos. La Tabla de las Naciones no es un árbol limpio — es una red trazada sobre un árbol.

---

**FIN DE GÉNESIS 10 — LA TRADUCCIÓN TRANSPARENTE (ESPAÑOL)**
