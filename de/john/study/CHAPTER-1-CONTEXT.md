# Johannes 1 — Kontextueller Studienbegleiter
## Die Transparente Ubersetzung (TT)
...
**Kapitel:** Johannes 1
**Sprache:** Deutsch
**Begleiter zu:** `de/john/CHAPTER-1.md` (Transparente Ausgabe)
**Regelwerk:** v3.0 (Regel 29 regelt diese Datei)
**Status:** vorlaufig

---

## A. Griechische Textmerkmale, die durch die TT sichtbar werden
...
### A2. Die Logos-Prolog-Struktur — chiastisch oder linear?
...
Die griechische Handschriftentradition ist an diesem Vers gespalten. Der Basistext der TT (NA28) liest μονογενὴς θεός ("einziggeborener Gott"), gestutzt durch die altesten Papyri (P66, P75) und die grossen Kodizes des vierten Jahrhunderts (Sinaiticus, Vaticanus). Die Variante ὁ μονογενὴς υἱός ("der einziggeborene Sohn") wird durch den Codex Alexandrinus, die byzantinische Mehrheitstradition und die meisten lateinischen und syrischen Versionen gestutzt. Die beiden Lesarten unterscheiden sich um ein einziges griechisches Wort, tragen aber erhebliches theologisches Gewicht: „einziggeborener Gott" ist eine der starksten vornicaenischen Bestatigungen der vollen Gottheit des Sohnes. Die TT ubersetzt die NA28-Lesart, weil sie der Basistext ist. Der Leser sollte wissen, dass die Variante existiert — viele traditionelle Ubersetzungen folgen der Lesart „einziggeborener Sohn" aus der byzantinischen/Vulgata-Tradition.
...
## G. Kuriositaten und offene Fragen
...
## H. Herangezogene Quellen

| Quelle | Typ | Abschnitte |
|--------|-----|------------|
| Nestle-Aland, *Novum Testamentum Graece*, 28. rev. Aufl. (Deutsche Bibelgesellschaft, 2012) | Primartext | Alle |
| LXX (Rahlfs-Hanhart, *Septuaginta*, rev. Aufl., Deutsche Bibelgesellschaft, 2006) | Primartext | A1, A5, B3, G2 |
| BHS, 5. rev. Aufl. (Deutsche Bibelgesellschaft, 1997) | Primartext | A1, A5 |
| Borgen, P., "The Logos Was the True Light," *Novum Testamentum* 14, 1972 | Begutachtet (Artikel) | B1 |
| Runia, D.T., *Philo of Alexandria and the Timaeus of Plato*, Brill, 1986 | Begutachtet (Monographie) | B1 |
| Witherington, B., *John's Wisdom*, Westminster John Knox, 1995 | Begutachtet (Kommentar) | B2 |
| Scott, M., *Sophia and the Johannine Jesus*, JSOT Press, 1992 | Begutachtet (Monographie) | B2 |
| Hooker, M.D., "In the Beginning Was the Word," in *The Beginnings of Christianity*, T&T Clark, 2004 | Begutachtet (Aufsatz) | B3 |
| Riesner, R., "Bethany Beyond the Jordan," in *Anchor Bible Dictionary*, Bd. 1, Doubleday, 1992 | Begutachtet (Enzyklopadie) | C1 |
| Waheeb, M., "Wadi al-Kharrar," *ADAJ* 41, 1997 | Begutachtet (Artikel) | C1 |
| Reinhartz, A., *Cast Out of the Covenant*, Lexington Books, 2018 | Begutachtet (Monographie) | C2 |
| Mason, S., "Pharisees," in *Anchor Bible Dictionary*, Bd. 5, Doubleday, 1992 | Begutachtet (Enzyklopadie) | C2 |
| Reich, R., *Miqwa'ot*, Israel Exploration Society, 2013 | Begutachtet (Monographie) | C3 |
| Taylor, J.E., *The Immerser*, Eerdmans, 1997 | Begutachtet (Monographie) | C3 |
| Colwell, E.C., "A Definite Rule for the Use of the Article in the Greek New Testament," *JBL* 52, 1933 | Begutachtet (Artikel) | A3 |
| BDAG (Danker, Bauer, Arndt, Gingrich), *A Greek-English Lexicon of the New Testament*, 3. Aufl., University of Chicago Press, 2000 | Begutachtet (Lexikon) | D1, A6 |
| Davies, P., *The Mind of God*, Simon & Schuster, 1992 | Akademisch-popular | E1 |
| Barrow, J.D., *The Constants of Nature*, Jonathan Cape, 2002 | Akademisch-popular | E1 |
| Ayres, L., *Nicaea and Its Legacy*, Oxford University Press, 2004 | Begutachtet (Monographie) | F1 |
| Young, F.M., *From Nicaea to Chalcedon*, 2. Aufl., Baker Academic, 2010 | Begutachtet (Monographie) | F1 |
| Boyarin, D., *Border Lines*, University of Pennsylvania Press, 2004 | Begutachtet (Monographie) | F2 |
| Novak, D., *Jewish-Christian Dialogue*, Oxford University Press, 1989 | Begutachtet (Monographie) | F2 |
| Parrinder, G., *Jesus in the Qur'an*, Oneworld, 1995 | Akademisch-popular | F3 |
| Khalidi, T., *The Muslim Jesus*, Harvard University Press, 2001 | Begutachtet (Monographie) | F3 |
| Strange, J.F., "Nazareth," in *Anchor Bible Dictionary*, Bd. 4, Doubleday, 1992 | Begutachtet (Enzyklopadie) | G3 |
| Pfann, S., "Nazareth," in *Oxford Encyclopedia of Archaeology in the Near East*, 1997 | Begutachtet (Enzyklopadie) | G3 |

---

**Redaktionelle Herkunft:**
- Erstellt von: Claude Opus 4.6 (KI-Assistent)
- Datum: 2026-04-27
- Gepruft von: ausstehend
