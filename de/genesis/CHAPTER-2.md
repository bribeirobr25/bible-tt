...
- [Glossar — Genesis 2](#glossar---genesis-2-ergänzungen-zum-gn-1-glossar)
- [Kapitelübergreifende Verfolgung (Gn 1 → Gn 2)](#kapitelübergreifende-verfolgung-gn-1--gn-2)
- [Deutsche Grammatische Besonderheiten (Gn 2)](#deutsche-grammatische-besonderheiten-gn-2)
...
*Prosa-Ansicht des gesamten Kapitels. Der Text ist identisch mit der Vers-für-Vers-Studie unten — gleiche Übersetzung, gleiche Zusätze in Kursivschrift, gleiche Formeln. Absatzumbrüche folgen natürlichen erzählerischen Fugen. Siehe den Studienabschnitt unten für die Notizen zu jedem Vers.*
...
>
> 🔵 **PASSIV**
> - **וַיְכֻלּוּ** (*vayekhullu*) = Passiv „wurden vollendet"—Agent (Gott) hier nicht genannt; der Agent erscheint in V.2
> - Deutsches Passiv mit *werden* + Partizip Perfekt bewahrt hebräische Stimme (Regel 8)
...
>
> 🟢 **RUHEN**
> - **וַיִּשְׁבֹּת** (*vayishbot*) = „und er ruhte/hörte auf"—Wurzel **שׁ-ב-ת** (*sh-b-t*), Quelle von *Schabbat* (Sabbat). Noch nicht das Substantiv *Schabbat*; es ist die verbale Handlung, die dem Tag den Namen gibt.
...
>
> 🔵 **„GESCHAFFEN, ZU MACHEN"**
> - **אֲשֶׁר־בָּרָא אֱלֹהִים לַעֲשׂוֹת** (*asher bara elohim la'asot*) = „das Gott geschaffen hatte, zu machen"—paart beide Schöpfungs-Verben aus Genesis 1 (*bara*, *asah*) in einem einzigen komprimierten Ausdruck. Infinitiv Konstrukt *la'asot* = „zu machen"; Interpretation **MÖGLICH**: „das er durch Machen geschaffen hatte" oder „geschaffen für den Zweck des Machens."
...
> - **לַעֲבֹד אֶת־הָאֲדָמָה** (*la'avod et-ha'adamah*) = „den Boden zu bearbeiten/zu dienen"—erste Erwähnung menschlicher *Arbeit* geht der Schöpfung des Menschen voraus. Wurzel **ע-ב-ד** (*'-b-d*) = dienen/arbeiten (dieselbe Wurzel wie „Diener" und „Anbetung").
...
>
> 🔵 **„IM OSTEN"**
> - **מִקֶּדֶם** (*miqqedem*) = „von Osten" / „von alters her"—mehrdeutig. Räumliche Lesart („im Osten") dominant; zeitliche Lesart („von alten Zeiten her") auch **MÖGLICH**.
...
>
> 🟢 **GUT UND BÖSE**
> - **טוֹב וָרָע** (*tov va-ra*) — die Paarung „gut/böse" kann ein Merismus sein („alles von X bis Y"), d.h. umfassende Erkenntnis. Bedeutung umstritten; Ambiguität bewahren.
...
> - **שֹׁהַם** (*shoham*) = „Schoham-Stein"—wahrscheinlich Onyx, Karneol oder Beryll; Identifikation **UNGEWISS**. Hier transliteriert, um falsche Präzision zu vermeiden.
...
> - **Strukturell bewahrt** gemäß Regel 5; Fremdheit ist beabsichtigt. Gepaart mit der negativen Entsprechung in V.17.
...
>
> 🔵 **PLURAL-ZU-SINGULAR**
> - Das Hebräische wechselt zwischen „sie" und „es/jedem": die Tiere werden kollektiv gebracht, aber die Benennung ist individuell. In der Übersetzung durch das kursive *jedem* bewahrt.
...
>
> 🔵 **„FÜR DEN MENSCHEN"**
> - **וּלְאָדָם** (*ul'adam*) hier ohne Artikel—**MÖGLICHER** Übergang zum Gebrauch als Eigenname. Die meisten Übersetzungen stellen den Artikel wieder her; das Hebräische erlaubt beide Lesungen.
...
> - **MÖGLICHE** Resonanz: später wird dieselbe Wurzel für architektonisches und familiäres „Bauen" verwendet (z.B. „ein Haus bauen" = eine Familienlinie gründen).
...
> - **Die erste aufgezeichnete menschliche Rede** in der Bibel.
>
> 🔵 **„DIESE, DIESES MAL"**
> - **זֹאת הַפַּעַם** (*zot hapa'am*) = „diese, dieses Mal"—emphatisch; kontrastiert mit den Tieren aus VV. 19–20, die sich nicht qualifizierten.
...
>
> 🟢 **„EIN FLEISCH"**
> - **בָּשָׂר אֶחָד** (*basar echad*) = „ein Fleisch"—dasselbe Adjektiv *echad* (einer) wie in Gn 1:5 *„ein Tag"*; hier beschreibt es Verbindung, nicht Zählung.
...
> - **Notiz gemäß Regel 14:** kann im Deutschen nicht vollständig wiedergegeben werden; dem Leser signalisiert.

---

## GLOSSAR - GENESIS 2 (Ergänzungen zum Gn-1-Glossar)

| Hebräisch | Deutsch | Notizen |
|-----------|---------|---------|
| יהוה | JHWH | Tetragrammaton; Regel 25 Option A (konsonantisch); erstes Auftreten V.4 |
| יהוה אֱלֹהִים | JHWH Elohim | Zusammengesetzter Gottesname; charakteristisch für Gn 2–3; niemals zu „Herr Gott" zusammengezogen |
| יָצַר | formte | Töpferverb; unterscheidet sich von *bara* und *asah*; verwendet für Mensch (V.7) und Tiere (V.19) |
| בָּנָה | baute | Konstruktionsverb; in Gn 2 nur für die Frau (V.22) verwendet |
| תּוֹלְדוֹת | Zeugungen / Ursprünge | Struktureller Marker in Genesis (11× im Buch); V.4 erstes Auftreten |
| צָבָא | Heer | Gesamtheit der erschaffenen Dinge; militärische Metapher |
| שָׁבַת | ruhte / hörte auf | Wurzel von *Schabbat*; erstes Auftreten V.2 |
| קָדַשׁ | heiligte / sonderte aus | Erstes Auftreten V.3 — das erste, was heilig genannt wird, ist eine Zeit |
| עֵדֶן | Eden | Ortsname; homophon mit „Wonne" |
| גָּן | Garten | Umfriedeter kultivierter Raum |
| עֵזֶר כְּנֶגְדּוֹ | Hilfe als sein Gegenüber | NICHT „Gehilfin"; *ezer* trägt keine Hierarchie |
| צֵלָע | Seite / Rippe | Ambiguität bewahrt (Regel 2) |
| תַּרְדֵּמָה | tiefer Schlaf | Göttlich induzierter Schlaf; keine Trance, kein Tod |
| אִישׁ / אִשָּׁה | *ish* / *ishah* | In V.23 transliteriert, um Wortspiel zu bewahren |
| עֲרוֹם | nackt | Wortspiel mit *arum* (listig, Gn 3:1) |
| אֵד | Dunst / Strom *(ungewiss)* | Seltenes Wort; erscheint nur 2× in der Hebräischen Bibel |

---

## KAPITELÜBERGREIFENDE VERFOLGUNG (Gn 1 → Gn 2)

**Schöpfungs-Verben-Wechsel:**
- Gn 1: *bara* (1:1, 1:21, 1:27), *asah* (1:7, 1:16, 1:25)
- Gn 2 führt ein: *yatzar* (2:7 Mensch, 2:19 Tiere), *banah* (2:22 Frau)
- Gn 2 paart auch *bara* + *asah* in der Zusammenfassung von 2:3 („geschaffen, zu machen")

**Gattungswechsel gemäß Regel 23:**
- Gn 1: liturgischer Rhythmus, gesperrte Formeln („Und Gott sprach... und es war so... dass gut... Abend und Morgen...")
- Gn 2: narrative Prosa; keine gesperrten Formeln. Die Formelstruktur von Gn 1 wird hier **nicht** auferlegt.

**Reihenfolgeumkehr:**
- Gn 1:1 — „Himmel und Land"
- Gn 2:4b — „Land und Himmel"

**Artikel bei *adam*:**
- Gn 1: *adam* (artikellos) in 1:26; *ha'adam* (mit Artikel) in 1:27—generische Menschheit
- Gn 2: *ha'adam* fast durchgehend—immer noch generisch „der Mensch"; noch kein Eigennamen-Gebrauch

**Erste Auftreten in Gn 2:**
- Erstes JHWH (V.4)
- Erstes „nicht gut" (V.18)
- Erste menschliche Rede (V.23)
- Erste Heiligung / heilige Kategorie (V.3)
- Erstes Gebot (V.16–17)

---

## DEUTSCHE GRAMMATISCHE BESONDERHEITEN (Gn 2)
...
**JHWH:**
- Konsonantische Transliteration des Tetragrammatons
- Deutsche Schreibweise: J statt Y (traditionelle deutsche Transliteration hebräischer Konsonanten)
- Regel 25 Option A angewendet

**Neue Verben in Konjugation:**
- *formte* (für *yatzar*) — deutsches *formen* gut geeignet
- *baute* (für *banah*) — deutsches *bauen* gut geeignet

**Konjunktiv I beibehalten:**
- „ich will ihm machen" (V.18) — moderne Form akzeptabel hier; keine archaische Verbform nötig

---

**ENDE VON GENESIS 2 - DIE TRANSPARENTE ÜBERSETZUNG (DEUTSCH)**
