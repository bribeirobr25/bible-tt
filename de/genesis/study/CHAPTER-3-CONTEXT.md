# Genesis 3 -- Kontextuelle Studienbegleitung
...
**Kapitel:** Genesis 3
**Sprache:** Deutsch
**Begleitdatei zu:** `de/genesis/CHAPTER-3.md` (Transparente Ausgabe)
...
Das hebräische Wort *pardes* (Garten/Park, aus dem Persischen) erscheint nicht in Genesis 1-3. Der Text sagt *gan eden* (Garten Eden). "Paradies" kommt über griechisch *paradeisos* (LXX-Übersetzung von *gan*) und wird in der westlichen Tradition zum Standard. Die TT bewahrt "Garten Eden" ohne Import von "Paradies".
...
|--------|-----|------------|
| Charlesworth, J.H., *The Good and Evil Serpent*, 2010 | Sekundär (Schlangenikonographie) | B1 |
| Moran, W.L., "Creation of Man in Atrahasis," *BASOR* 200, 1970 | Artikel (AO) | B2 |
| Parpola, S., "Assyrian Tree of Life," *JNES* 52, 1993 | Artikel (AO Kunst) | B3 |
| Mettinger, T.N.D., "Cherubim," *DDD*, 1999 | Nachschlagewerk (AO) | C1 |
| Levenson, J.D., *Death and Resurrection of the Beloved Son*, 1993 | Sekundär (Jüdisch) | F1 |
