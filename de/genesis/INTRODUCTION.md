...
**Welche Art von Aussage?** (gibt die Herkunft der Information an)
- **TEXTUELL** — direkt aus dem hebräischen Text abgeleitet
- **STARKE SCHLUSSFOLGERUNG** — logisch vom Text impliziert, nicht explizit ausgesagt
- **MÖGLICHE SCHLUSSFOLGERUNG** — eine legitime Lesart unter anderen
- **VERGLEICHENDE PARALLELE** — in einer anderen altorientalischen oder antiken Quelle belegt
- **SPÄTERE REZEPTION** — nachbiblische Lesart
- **HISTORISCH / ARCHÄOLOGISCH** — auf materielle oder historische Evidenz gestützt
- **WISSENSCHAFTLICHER VERGLEICH** — moderner empirischer Befund im Vergleich zum Text
- **SPEKULATION** — keine starke textliche oder evidentielle Grundlage

**Wie sicher?** (gibt den Sicherheitsgrad an)
- **VERIFIZIERT** — starke Evidenz, breite Übereinstimmung
- **WAHRSCHEINLICH** — gut gestützt, aber diskutiert
- **MÖGLICH** — eine vernünftige Lesart unter anderen
- **UNSICHER** — tatsächlich unklar
- **SPEKULATIV** — muss selten sein und deutlich gekennzeichnet
- **DOKUMENTIERT** — historisch belegte Rezeption (für Einträge der SPÄTEREN REZEPTION)

**Leseprinzip:** Beginnen Sie mit den TEXTUELLEN Einträgen — diese stammen aus dem Hebräischen selbst. Dann erkunden Sie weiter zu Parallelen, Rezeption und Vergleich. Die Einleitung präsentiert; Sie beurteilen.
...
**Aktuelle Modelle weichen erheblich ab:** **[VERGLEICHENDE PARALLELE — WAHRSCHEINLICH]**

- **Ergänzungsmodelle** (Blum, Carr): Ein Basisdokument wurde fortschreitend ergänzt, anstatt dass vier unabhängige Quellen mechanisch zusammengefügt wurden. Betont redaktionelles Wachstum gegenüber Quellentrennung.
...
|--------|-----|------------|
| Wenham, G. J. *Genesis 1–15* (WBC, 1987) | Kommentar | A, B, C, F |
| Wenham, G. J. *Genesis 16–50* (WBC, 1994) | Kommentar | A, D |
| Westermann, C. *Genesis 1–11* (CC, 1984) | Kommentar | A, B, D |
| von Rad, G. *Genesis* (OTL, 1961) | Kommentar | A, D |
| Speiser, E. A. *Genesis* (AB, 1964) | Kommentar | A, B |
| Wellhausen, J. *Prolegomena zur Geschichte Israels* (1878) | Quellenkritik | B |
| Blum, E. *Studien zur Komposition des Pentateuch* (1990) | Quellenkritik | B |
| Baden, J. *The Composition of the Pentateuch* (2012) | Quellenkritik | B |
| Schmid, K. *The Old Testament: A Literary History* (2012) | Literaturgeschichte | B, C |
| Schmid, K. *Genesis and the Moses Story* (2010) | Komposition | B, C |
| Römer, T. *The Invention of God* (2015) | Religionsgeschichte | C, D |
| Carr, D. *Reading the Fractures of Genesis* (1996) | Literarische Analyse | A, B |
| Rendtorff, R. *The Problem of the Process of Transmission* (1990) | Überlieferung | A, B |
| Thompson, T. L. *The Historicity of the Patriarchal Narratives* (1974) | Historizität | C |
| Millard, A. und Wiseman, D. J. Hg. *Essays on the Patriarchal Narratives* (1980) | Historizität | C |
| Cross, F. M. *Canaanite Myth and Hebrew Epic* (1973) | Altorientalische Parallelen | A, D |
| Dalley, S. *Myths from Mesopotamia* (1989) | Altorientalische Parallelen | D |
| Lambert, W. G. *Babylonian Creation Myths* (2013) | Altorientalische Parallelen | D |
| Hess, R. und Tsumura, D. Hg. *I Studied Inscriptions from Before the Flood* (1994) | Altorientalische Parallelen | D |
| Levenson, J. D. *Creation and the Persistence of Evil* (1988) | Theologie | D |
| Tov, E. *Textual Criticism of the Hebrew Bible* (3. Aufl., 2012) | Textkritik | E |
| Ulrich, E. *The Dead Sea Scrolls and the Origins of the Bible* (1999) | Textkritik | E |
| Leiman, S. Z. *The Canonization of Hebrew Scripture* (1976) | Kanon | B |
| McDonald, L. M. *The Biblical Canon* (2007) | Kanon | B |
| Albertz, R. *Israel in Exile* (2003) | Geschichte | D |
| Tengström, S. *Die Toledotformel* (1982) | Struktur | A |
| Spinoza, B. *Tractatus Theologico-Politicus* (1670) | Geschichte der Kritik | B |
| Astruc, J. *Conjectures sur les mémoires originaux* (1753) | Geschichte der Kritik | B |
| Holmstedt, R. „The Restrictive Syntax of Genesis i 1", *VT* 58 (2008) | Syntax | F |

---

> **Redaktionelle Herkunft:** Entwurf von Claude Opus 4.6 (1M context) am 28.04.2026. Noch nicht geprüft. Diese Einleitung ist eine provisorische wissenschaftliche Ressource, die der TT-Regel 29 unterliegt. Alle Aussagen tragen doppelte Kennzeichnungen; keine Aussage sollte als theologische oder kompositionelle Position der TT gelesen werden. Die TT übersetzt den Masoretischen Text und übernimmt keine bestimmte Theorie der Autorschaft oder Komposition.
