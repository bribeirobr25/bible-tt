...
- [Glossary — Genesis 8](#glossary---genesis-8)
- [Cross-Chapter Tracking (Gen 7 → Gen 8)](#cross-chapter-tracking-gen-7--gen-8)
...
>
> 🔴 **CRITICAL — RUACH OVER THE WATERS — RE-CREATION**
> - **וַיַּעֲבֵר אֱלֹהִים רוּחַ עַל־הָאָרֶץ** = "God caused a *ruach* to pass over the land." Direct echo of Gen 1:2: "and *ruach* of God hovering over the face of the waters." The same word (*ruach* = wind/spirit) in the same cosmic context: wind/spirit over water. The flood recession closely echoes how creation began — *ruach* over water. Re-creation.
> - Rule 2 slash preserved: wind/spirit.
...
>
> 🟢 **"RESTED" (*tanach*)**
> - **וַתָּנַח** (*vattanach*) = "and rested." Root: נ-ו-ח (*n-w-ch*) — the SAME root as **Noach**'s name. The tebah "*noach*-ed" on the mountains. The name-meaning ("rest/comfort") is enacted in the narrative.
...
> - Gen 8:21: "the inclination of the heart of the human is evil from his youth" → MERCY (never again).
> - The 8:21 version is **softer**: drops "every" (*kol*), drops "only" (*raq*), drops "all the day" (*kol ha-yom*), adds "from his youth" (*mine'urav*). The human condition is the same, but the response reverses.
>
> 🟡 **"SAID IN HIS HEART"**
> - **וַיֹּאמֶר יהוה אֶל־לִבּוֹ** = "YHWH said to his heart" — internal divine speech, not a public declaration. The resolve is private. This internal commitment precedes the public covenant of Gen 9.
...
>
> 🟢 **"WHILE YET ALL THE DAYS OF THE LAND" (*od kol yemei ha-aretz*)**
> - **עֹד כָּל־יְמֵי הָאָרֶץ** = "while yet all the days of the land" — i.e., for as long as the land endures. An indefinite but bounded guarantee.

---

## GLOSSARY — GENESIS 8 (additions to Gen 1–7 glossary)

| Hebrew | English | Notes |
|--------|---------|-------|
| עֹרֵב | raven | First bird sent; returns without result. |
| יוֹנָה | dove | Test-bird; three sendings with progressive results. |
| מָנוֹחַ | resting place | Root n-w-ch — same as Noach. The dove seeks "noach." |
| חַלּוֹן | window | Distinct from *tsohar* (6:16, uncertain). |
| אֲרָרָט | Ararat | Mountain range (plural), not single peak. Ancient Urartu. |
| מִזְבֵּחַ | altar | First occurrence (8:20). From root z-b-ch (sacrifice). |
| עֹלָה | burnt offering | First occurrence (8:20). Completely consumed on altar. |
| נִיחֹחַ | pleasing/soothing | Root n-w-ch — same as Noach. Aroma of "rest." |

---

## CROSS-CHAPTER TRACKING (Gen 7 → Gen 8)

**Re-creation parallel:**
- Gen 1:2: *ruach* of God over the waters → Gen 8:1: God causes *ruach* over the land
- Gen 1:9: "Let the dry ground appear" → Gen 8:5: "tops of the mountains appeared"
- Gen 1:22: "Be fruitful and multiply" (to creatures) → Gen 8:17: "be fruitful and multiply upon the land"
- Gen 1:5: day/night established → Gen 8:22: day/night "shall not cease"

**N-W-CH root saturation in Gen 8:**
- Noach (name = rest/comfort)
- 8:4: tebah *tanach* (rested) on Ararat
- 8:9: dove cannot find *manoach* (resting place)
- 8:21: YHWH smells *nichoach* (pleasing/soothing aroma)
- Four occurrences of the n-w-ch root in one chapter — all connected to the name-bearer.

**Yetser comparison (6:5 vs 8:21):**
- 6:5: "**every** inclination... **only** evil **all the day**" → flood
- 8:21: "the inclination... evil **from his youth**" → never again
- Same word (*yetser*), softer framing, opposite divine response

**Chronological framework (flood timeline):**
- 7:11: flood begins — Year 600, Month 2, Day 17
- 7:24: waters prevail 150 days
- 8:4: tebah rests — Month 7, Day 17 (exactly 150 days later)
- 8:5: mountaintops visible — Month 10, Day 1
- 8:6: 40 more days → raven sent
- 8:10,12: two more 7-day waits → dove sent twice more
- 8:13: surface dried — Year 601, Month 1, Day 1
- 8:14: fully dried — Month 2, Day 27
- Total flood duration: near one-year narrative frame (370–371 days)

**Divine name distribution in Gen 8:**
- 8:1: God/Elohim (remembering, cosmic act)
- 8:15: God/Elohim (command to exit)
- 8:20: YHWH (sacrifice, personal relationship)
- 8:21: YHWH (internal commitment, emotional response)
...
**END OF GENESIS 8 — THE TRANSPARENT TRANSLATION (ENGLISH)**
