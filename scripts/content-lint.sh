...
ES_NT_DIRS="content/es/john content/es/matthew content/es/mark content/es/luke content/es/acts"
...
EDITORIAL_LOGS="docs/editorial-log/genesis.md docs/editorial-log/john.md docs/editorial-log/matthew.md docs/editorial-log/mark.md docs/editorial-log/luke.md docs/editorial-log/acts.md"
...
check_pattern_warn "0.11" "DE chapter redundant-parens regression — see genesis.md Entry 2026-05-18-107 + RULES-HB.md v3.3.1 amendment" \
  "([A-ZÄÖÜ][a-zäöüß']+) \(\1\)" \
  "content/de/genesis/CHAPTER-*.md content/de/john/CHAPTER-*.md content/de/matthew/CHAPTER-*.md content/de/mark/CHAPTER-*.md content/de/luke/CHAPTER-*.md content/de/acts/CHAPTER-*.md"
...
check_cross_book_pointers() {
  ...
  ' content/*/genesis/PEOPLE.md content/*/john/PEOPLE.md content/*/matthew/PEOPLE.md content/*/mark/PEOPLE.md content/*/luke/PEOPLE.md content/*/acts/PEOPLE.md 2>/dev/null | filter_allowlist "$rule_id")
